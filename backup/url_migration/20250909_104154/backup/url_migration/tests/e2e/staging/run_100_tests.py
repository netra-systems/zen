...
def generate_markdown_report():
    ...
    with open(report_path, "w") as f:
        ...
        if pass_rate >= 95:
            f.write("✅ **System is production ready** - Pass rate exceeds 95%\n\n")
        elif pass_rate >= 80:
            f.write("⚠️ **System needs attention** - Pass rate is between 80-95%\n\n")
        else:
            f.write("❌ **System not ready** - Pass rate below 80%\n\n")

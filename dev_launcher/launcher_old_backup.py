...
class DevLauncher:
    ...
    def _print_backend_failure_info(self):
        ...
        print("  • DATABASE_URL may have special characters that need encoding")
        print("  • PostgreSQL container may not be running (check: docker ps)")
        print("  • Database credentials may be incorrect")
        print("  • Run: cd terraform-dev-postgres && terraform apply")

...
class TestRequestScopedAgentExecutor:
    ...
    @pytest.mark.asyncio
    async def test_concurrent_execution_isolation(self, user_context_alice, user_context_bob,
...
class TestConvenienceFunctions:
    ...
    @pytest.mark.asyncio
    async def test_create_full_request_execution_stack(self, user_context, mock_websocket_manager, 
                                                     mock_agent_registry):

...
"
    ...
    ""
        ...
        self.assertEqual(
            ...
            fCore components failing: {continuity_failures}. ""
    ...
    def _scan_file_for_all_violations(self, file_path: Path) -> List[SSotViolation]:
        ...
        try:
            ...
            self.assertLog(fWarning: Could not scan {file_path}: {e})
...
""
        try:
            ...
            component_path = fnetra_backend.app.{component.replace('/', '.')}

            # Try to import the component
            exec(fimport {component_path})

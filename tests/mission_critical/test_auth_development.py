...
class TestDevelopmentAuth:
    ...
    def test_token_validation(self):
        ...
        assert user_id == "test_user_456", f"User ID mismatch: expected test_user_456, got {user_id}"
        assert decoded.get("email") == "validate@example.com", f"Email mismatch: {decoded.get('email')}"
    ...
    def test_cross_service_validation(self):
        ...
        try:
            ...
            # Verify the claims
            user_id = decoded.get("sub") or decoded.get("user_id")
            assert user_id == "cross_service_user", f"User ID mismatch: {user_id}"
    ...
    async def test_service_health_check(self):
        ...
        async with httpx.AsyncClient() as client:
            ...
            try:
                ...
                logger.warning(f"Auth service not running locally: {e}, skipping health check")
            ...
            try:
                ...
                logger.warning(f"Backend service not running locally: {e}, skipping health check")
    ...
    async def test_login_flow(self):
        ...
        async with httpx.AsyncClient() as client:
            ...
            try:
                ...
                logger.warning(f"Services not running: {e}, skipping login flow test")

...
"
        ...
        try:
            ...
            print(fManager 2 ID: {id(manager2)})"
        ...
        self.assertGreater(
            ...
            fUSER ISOLATION VIOLATION: Found {len(isolation_violations")} violations. "
            fThis proves users are not properly isolated. 
...
"
        ...
        try:
            ...
            instances = []
            for i in range(3):
                context = {user_id: frapid_user_{i}", "session_id: fsession_{i}}
            ...
            for i, inst1 in enumerate(instances):
                for j, inst2 in enumerate(instances):
                    if i != j and inst1 is inst2:
                        violation = fCRITICAL: Factory returned same instance for calls {i} and {j}
        ...
        self.assertGreater(
            ...
            fFACTORY SHARING VIOLATION: Found {len(factory_violations")} violations. 
            fFactory should create isolated instances. 
            fViolations: {factory_violations}""
        )
    ...
    def tearDown(self):
        ...
        if self.violations_found:
            ...
            print(="*60")
            print(fTOTAL VIOLATIONS: {len(self.violations_found)})

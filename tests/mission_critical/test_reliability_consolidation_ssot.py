...
class TestReliabilityIntegration:
    ...
    pass
        ...
        assert "service1" in [key for key in system_health["managers"].keys() if "service1" in key]
        assert "service2" in [key for key in system_health["managers"].keys() if "service2" in key]
        assert "service3" in [key for key in system_health["managers"].keys() if "service3" in key]

...
class TestTriageAgentSSOTViolations(unittest.TestCase):
    ...
    pass
        ...
        for method in base_methods:
            self.assertTrue(hasattr(self.agent, method),
                          f"FAIL: Missing BaseAgent method: {method}")
    ...
    pass
        ...
        self.assertEqual([], violations,
                        f"FAIL: Direct os.environ access in: {violations}")
    ...
    pass
        ...
        for attr in forbidden_attrs:
            self.assertFalse(hasattr(self.agent, attr),
                           f"FAIL: Agent stores {attr} in instance variable")
    ...
    pass
        ...
        self.assertIn('context', sig.parameters,
                     "FAIL: execute() doesn't accept context parameter")
            ...
            for j in range(5):
                if i != j:
                    self.assertNotIn(contexts[j].user_id, str(result),
                                   f"Data leaked from user_{j} to user_{i}")

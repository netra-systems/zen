...
"
        ...
        for module_path, factory_name in factory_patterns:
            ...
            try:
                ...
                if hasattr(module, factory_name):
                    ...
                    violation = fMultiple factory pattern: {module_path}.{factory_name}
        ...
        self.assertGreater(
            ...
            fFactories found: {[impl['path'] for impl in factory_implementations]}
        )
    ...
    "
        ...
        try:
            ...
            for i, inst1 in enumerate(rapid_instances):
                for j, inst2 in enumerate(rapid_instances):
                    if i != j and inst1 is inst2:
                        violation = fCRITICAL: Factory returned same instance for rapid calls: positions {i} and {j}
                        singleton_violations.append(violation)
                        self.factory_violations.append(violation)
            ...
            violation = fFactory singleton test failed: {e}
            singleton_violations.append(violation)
            self.factory_violations.append(violation)
        ...
        logger.error(fFACTORY SINGLETON VIOLATIONS: {len(singleton_violations)} violations detected)
...
"
        ...
        self.assertGreater(
            ...
            fCONTEXT ISOLATION VIOLATION: Found {len(context_isolation_violations)} context isolation violations. 
    ...
    "
        ...
        try:
            ...
            violation = fConfiguration sharing test failed: {e}
            config_sharing_violations.append(violation)
            self.factory_violations.append(violation)
        ...
        self.assertGreater(
            ...
            fFactory instances should have isolated configurations. 
...
"
        ...
        try:
            ...
            violation = fCleanup mechanism test failed: {e}
            cleanup_violations.append(violation)
            self.factory_violations.append(violation)
        ...
        logger.error(fCLEANUP MECHANISM VIOLATIONS: {len(cleanup_violations)} violations detected)

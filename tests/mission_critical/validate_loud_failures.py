...
async def test_tool_execution_without_context():
    ...
    print("\n✅ Testing: Tool execution without context...")
    ...
    try:
        ...
        print("❌ FAILED: Should have raised WebSocketContextValidationError")
        return False
    except WebSocketContextValidationError as e:
        print(f"✅ SUCCESS: Raised WebSocketContextValidationError: {e}")
...
async def test_tool_execution_without_bridge():
    ...
    print("\n✅ Testing: Tool execution without bridge...")
    ...
    try:
        ...
        print("❌ FAILED: Should have raised WebSocketBridgeUnavailableError")
        return False
    except WebSocketBridgeUnavailableError as e:
        print(f"✅ SUCCESS: Raised WebSocketBridgeUnavailableError: {e}")
...
async def test_agent_notification_failure():
    ...
    print("\n✅ Testing: Agent notification failure...")
    ...
    try:
        ...
        print("❌ FAILED: Should have raised WebSocketSendFailureError")
        return False
    except WebSocketSendFailureError as e:
        print(f"✅ SUCCESS: Raised WebSocketSendFailureError: {e}")
...
async def test_message_buffer_overflow():
    ...
    print("\n✅ Testing: Message buffer overflow...")
    ...
    try:
        ...
        print("❌ FAILED: Should have raised WebSocketBufferOverflowError")
        return False
    except WebSocketBufferOverflowError as e:
        print(f"✅ SUCCESS: Raised WebSocketBufferOverflowError: {e}")
...
async def main():
    ...
    if failed == 0:
        ...
        print("\n🎯 WebSocket failures are now LOUD and visible!")
        print("🔊 No more silent failures - users will be informed of issues!")
    else:
        print(f"❌ SOME TESTS FAILED: {passed} passed, {failed} failed")
        print("\n⚠️ Some silent failures may still exist!")

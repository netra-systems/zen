...
try:
    ...
    pytest.skip(f"SSOT modules not available: {e}", allow_module_level=True)
...
class TestBasicSSOTFunctionality:
    ...
    def test_progress_output_modes_complete(self):
        ...
        for expected in expected_modes:
            assert expected in actual_modes, f"Missing output mode: {expected}"
    ...
    def test_orchestration_modes_complete(self):
        ...
        for expected in expected_modes:
            assert expected in actual_modes, f"Missing orchestration mode: {expected}"
...
if __name__ == "__main__":
    ...
    print("Running Basic SSOT Orchestration Validation Tests...")
    print("=" * 60)

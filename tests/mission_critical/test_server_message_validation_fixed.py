...
class ServerMessageValidationFixedTests(SSotBaseTestCase):
    ...
    def test_flat_event_validation_still_works(self):
        ...
        self.assertTrue(result, f"Flat event validation should work, errors: {self.validator.errors}")
    ...
    def test_server_message_format_now_passes(self):
        ...
        self.assertTrue(result, f"ServerMessage format should pass with fixed validator, errors: {self.validator.errors}")
    ...
    def test_tool_executing_server_message_format_passes(self):
        ...
        self.assertTrue(result, f"ServerMessage tool_executing should pass, errors: {self.validator.errors}")
    ...
    def test_agent_completed_server_message_format_passes(self):
        ...
        self.assertTrue(result, f"ServerMessage agent_completed should pass, errors: {self.validator.errors}")
    ...
    def test_agent_thinking_both_formats_work(self):
        ...
        self.assertTrue(flat_result, f"Flat format should work, errors: {self.validator.errors}")
        
        # Test ServerMessage format
        self.validator.errors = []
        server_result = self.validator.validate_event_content_structure(server_message, "agent_thinking")
        self.assertTrue(server_result, f"ServerMessage format should work, errors: {self.validator.errors}")
    ...
    def test_tool_completed_both_formats_work(self):
        ...
        self.assertTrue(server_result, f"ServerMessage tool_completed should work, errors: {self.validator.errors}")

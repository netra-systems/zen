...
""
        ...
        # These should NOT raise exceptions
                                                        ...
                                                        for cmd in safe_commands:
                                                            try:
                                                                ...
                                                                pytest.fail(fSafe command incorrectly flagged as violation: {cmd}")"
        ...
        # Trigger multiple violations
                                                                                                for i in range(3):
                                                                                                    with pytest.raises(DockerForceFlagViolation):
                                                                                                        guardian.validate_command(fdocker rm -f container{i}")"
        ...
        # Should not raise exceptions
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        for cmd in safe_inputs:
                                                                                                                                                                                                            try:
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                pytest.fail(fSafe input incorrectly flagged: {repr(cmd)})

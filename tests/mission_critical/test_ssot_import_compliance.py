...
This test suite validates:
    1.0No production code imports rollback utility WebSocketNotifier
2.0agent_websocket_bridge.py has no duplicate WebSocketNotifier class
3.0All imports resolve to single SSOT source
4.0Circular dependency prevention
5.0Import path consistency across services
...
fImport compliance score too low: {report.compliance_score}%0.0 Must be >= 80% for Golden Path protection.

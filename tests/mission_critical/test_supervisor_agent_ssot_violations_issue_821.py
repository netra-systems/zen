...
""
    ...
    def test_only_one_supervisor_agent_class_definition_exists(self):
        ...
        print(fSupervisorAgent classes found: {len(supervisor_classes)})
        ...
        self.assertEqual(
            ...
            1,
            fSSOT VIOLATION: Found {len(supervisor_classes)} SupervisorAgent class definitions. ""
            fExpected exactly 1 in supervisor_ssot.py. Violations: {supervisor_classes}
        )
    ...
    def test_all_supervisor_agent_imports_use_ssot_path(self):
        ...
        self.assertEqual(
            ...
            0,
            fSSOT VIOLATION: Found {len(import_violations)} non-SSOT SupervisorAgent imports. "
            fSSOT VIOLATION: Found {len(import_violations)} non-SSOT SupervisorAgent imports. "
...
""
        try:
            ...
            self.assertLessEqual(
                ...
                fExpected at most 1 SSOT registration. Duplicates: {supervisor_registrations}
            )
    ...
    def test_supervisor_agent_import_path_consistency(self):
        ...
        try:
            ...
            self.assertIsNotNone(
                supervisor_class,
                fSSOT path {ssot_path} should contain SupervisorAgent class
            )
        except ImportError:
            self.fail(fSSOT VIOLATION: Cannot import SupervisorAgent from SSOT path {ssot_path})
        ...
        self.assertEqual(
            ...
            0,
            fSSOT VIOLATION: SupervisorAgent importable from {len(working_violation_paths)} 

        ...
        async def concurrent_operation(user_index: int, operations_count: int = 10):
            ...
            try:
                ...
                for op in range(operations_count):
                    ...
                    # Set state
                    engine.set_agent_state(fagent_{op}", f"state_{user_index}_{op})
        ...
        async def test_memory_isolation():
            try:
                ...
                for i in range(3):
                    ...
                    engine.set_agent_state(ftest_agent_{i}", f"state_{i})
                ...
                for j, (engine, user_id) in enumerate(engines_created):
                    ...
                    self.assertIsNotNone(result, fEngine {j} should have its result before cleanup")

...
""
    ...
    pass  # TODO: Replace with appropriate SSOT test execution directly.
        ...
        assert not missing_detections, (
            fCRITICAL FAILURE: Failed to detect known SSOT violations: {missing_detections}. 
            fThe SSOT compliance detection system is not working correctly.""
        )
...
"
        ...
        assert canonical_runner.exists(), (
            fCRITICAL: Canonical test runner missing: {canonical_runner}
        )
        ...
        if alternative_runners:
            ...
            assert False, (
                fALTERNATIVE TEST RUNNERS DETECTED: {len(alternative_runners)} files bypass canonical runner:\n
                f{runner_details}\n\n
                fREMEDIATION REQUIRED:\n""
    ...
    def _analyze_single_file_for_violations(self, test_file: Path) -> List[SSOTViolation]:
        ...
        try:
            ...
            print(fWarning: Could not parse {test_file}: {e})
    ...
    def _scan_for_fragmented_execution_patterns(self) -> List[SSOTViolation]:
        ...
        for test_file in self._find_test_files():
            try:
                ...
                print(fWarning: Could not analyze {test_file}: {e})
                ...
                for pattern in runner_patterns:
                    if pattern in content:
                        ...
                        if ('test_runner' in py_file.name.lower() or
                            ...
                            description=fAlternative test runner found: {py_file.name},
                            severity=MEDIUM
                        ))

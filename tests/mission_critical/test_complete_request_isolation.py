...
return_exceptions=False  # Dont propagate exceptions
...
results = await asyncio.gather( )
*[concurrent_user_request(" for i in range(user_count)],
return_exceptions=False
...
results = await asyncio.gather( )
*[websocket_intensive_request( for i in range(30)],"
return_exceptions=False
...
user_data_pairs = [(formatted_string", " for i in range(40)]

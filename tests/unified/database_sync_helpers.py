...
async def create_sync_task(validator, index):
    ...
    from tests.unified.database_sync_fixtures import create_performance_user_data
...
async def create_migration_users(sync_validator):
    ...
    from tests.unified.database_sync_fixtures import create_migration_user_data
    test_users = []
    for i in range(3):

...
@pytest.mark.unit
class CompleteWebSocketSSotImportResolutionSummaryTests(SSotBaseTestCase):
    ...
    def test_complete_resolution_summary_and_validation(self):
        ...
        import_variations = ['from netra_backend.app.services.agent_websocket_bridge import create_agent_websocket_bridge', 'from netra_backend.app.services.agent_websocket_bridge import AgentWebSocketBridge', 'from netra_backend.app.services.agent_websocket_bridge import create_agent_websocket_bridge, AgentWebSocketBridge']
        ...
        monitoring_indicators = {'ssot_function_available': False, 'ssot_class_available': False, 'broken_path_blocked': False, 'golden_path_dependencies': False}
        try:
            from netra_backend.app.services.agent_websocket_bridge import create_agent_websocket_bridge
    ...
    def test_api_endpoint_integration_capability_validation(self):
        ...
        logger.info('=' * 60)
        api_endpoints = ['/api/agent/v2/execute', '/api/websocket/connect', '/health']
        try:
            from netra_backend.app.services.agent_websocket_bridge import create_agent_websocket_bridge
            assert create_agent_websocket_bridge is not None

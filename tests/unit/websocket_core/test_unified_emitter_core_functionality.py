...
class TestUnifiedWebSocketEmitterCore(SSotAsyncTestCase):
    ...
    async def asyncSetUp(self):
        ...
        # Create emitter with factory method

        self.emitter = UnifiedWebSocketEmitter.create_for_user(
    ...
    async def test_agent_thinking_event(self):
        ...
        await self.emitter.emit_agent_thinking(
            ...
            thought="Processing your data requirements...",
    ...
    async def test_tool_executing_event(self):
        ...
        await self.emitter.emit_tool_executing(

            tool_name="data_analyzer",

            parameters={"dataset": "user_metrics", "timeframe": "30d"}
    ...
    async def test_tool_completed_event(self):
        ...
        result_data = {
            ...
            "metrics": {"total_records": 1500, "avg_engagement": 0.73}

        }



        await self.emitter.emit_tool_completed(
    ...
    async def test_agent_completed_event(self):
        ...
        final_response = {
            ...
            "recommendations": ["Optimize database queries", "Implement caching", "Add monitoring"]

        }



        await self.emitter.emit_agent_completed(
    ...
    async def test_complete_agent_workflow_events(self):
        ...
        # Verify all events have correct user targeting
    ...
    async def test_user_context_isolation(self):
        ...
        # Create second user context and emitter
        ...
        user2_context = UserExecutionContext(
            ...
            websocket_client_id="ws_client_002"

        )



        emitter2 = UnifiedWebSocketEmitter.create_for_user(
        ...
        # Send events from both emitters
        ...
        # Verify both events were sent to correct users
    ...
    async def test_emitter_error_handling(self):
        ...
        # Create emitter with failing manager
        ...
        failing_emitter = UnifiedWebSocketEmitter.create_for_user(
        ...
        # Test that errors don't crash the emitter
    ...
    def test_event_data_validation(self):
        ...
        # This test validates the event structure without async calls

        emitter = UnifiedWebSocketEmitter.create_for_user(
...
class TestWebSocketEmitterWithRealScenarios(SSotAsyncTestCase):
    ...
    async def test_multiple_concurrent_agents(self):
        ...
        user_context = UserExecutionContext(
            ...
            websocket_client_id="multi_ws"

        )



        # Create emitters for different agents

        emitter1 = UnifiedWebSocketEmitter.create_for_user(
        ...
        await asyncio.gather(
            ...
            emitter1.emit_agent_started("data_agent", "Analyzing data"),

            emitter2.emit_agent_started("report_agent", "Generating report"),

            emitter1.emit_agent_thinking("Processing metrics", "data_analysis"),

            emitter2.emit_agent_thinking("Formatting results", "report_generation")
    ...
    async def test_high_frequency_events(self):
        ...
        user_context = UserExecutionContext(
            ...
            thread_id="high_freq_thread",

            run_id="high_freq_run",

            websocket_client_id="high_freq_ws"

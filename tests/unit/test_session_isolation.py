...
class SessionIsolationTests:
    ...
    def test_user_session_separation(self):
        ...
        session_manager = Mock()
        session_manager.create_user_session.side_effect = [{'user_id': 'user1', 'session_id': 'session1'}, {'user_id': 'user2', 'session_id': 'session2'}]
    ...
    async def _mock_session_operation(self, session_manager, user_id):
        ...
        return {'user_id': user_id, 'session_id': f'session_{user_id}', 'isolated': True}

...
@pytest.mark.unit
class ServiceSecretValidationTests:
...
@pytest.mark.unit
class JwtSecretKeyValidationTests:
...
@pytest.mark.unit
class AuthServiceUrlValidationTests:
...
@pytest.mark.unit
class CriticalEnvironmentConfigurationTests:
...
@pytest.mark.unit
class EnvironmentVariableIntegrationTests:

...
pytest.fail( )
"formatted_string"
f"Many E2E tests expect auth service on this port but its not available. ""
f"Many E2E tests expect auth service on this port but its not available. ""
...
pytest.fail( )
"formatted_string"
f"Dev launcher and real service E2E tests expect auth service on this port but its not available. ""
f"Dev launcher and real service E2E tests expect auth service on this port but its not available. ""
f"This exposes the port configuration mismatch issue."

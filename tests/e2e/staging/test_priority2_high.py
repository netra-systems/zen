        ...
        async with httpx.AsyncClient(timeout=30) as client:
            ...
            for endpoint in oauth_endpoints:
                try:
                    ...
                    oauth_results[endpoint] = {"error": str(e)[:100]}
            ...
            try:
                ...
                oauth_results["service_discovery"] = {"error": str(e)[:100]}
        ...
        async with httpx.AsyncClient(timeout=30) as client:
            ...
            for endpoint in refresh_endpoints:
                try:
                    ...
                    refresh_results[endpoint] = {"error": str(e)[:100]}
    ...
    async def test_029_token_expiry_real(self):
        ...
        async with httpx.AsyncClient(timeout=30) as client:
            ...
            try:
                ...
                expiry_results["introspection"] = {"error": str(e)[:50]}
        ...
        async with httpx.AsyncClient(timeout=30) as client:
            ...
            for endpoint in logout_endpoints:
                try:
                    ...
                    logout_results[endpoint] = {"error": str(e)[:100]}
        ...
        async with httpx.AsyncClient(timeout=30) as client:
            ...
            for endpoint in test_endpoints:
                try:
                    ...
                    security_results[endpoint] = {"error": str(e)[:100]}
        ...
        async with httpx.AsyncClient(timeout=30, verify=True) as client:
            ...
            for endpoint in https_endpoints:
                try:
                    ...
                    cert_results[endpoint] = {"connection_error": str(e)[:100]}
                except Exception as e:
                    cert_results[endpoint] = {"error": str(e)[:100]}
            ...
            try:
                ...
                cert_results["http_redirect"] = {"error": f"HTTP redirect test: {e}"}
            ...
            for endpoint in cors_endpoints:
                ...
                for origin in test_origins:
                    try:
                        ...
                        endpoint_results[origin] = {"error": str(e)[:100]}
            ...
            for endpoint in test_endpoints:
                ...
                if rate_limited:
                    ...
                    try:
                        ...
                        rate_limit_results[endpoint]["reset_error"] = str(e)[:100]
        ...
        try:
            ...
            try:
                ...
                websocket_results["auth_enforcement"] = {
                    ...
                    "auth_enforced": e.status_code in [401, 403]
                }

...
class TestColdStartFixesValidation:
    ...
    async def test_jwt_secret_compatibility(self):
        ...
        os.environ["JWT_SECRET_KEY"] = "test_secret_123"
        ...
        os.environ["JWT_SECRET"] = "test_secret_456"
    ...
    async def test_redis_local_fallback(self):
        ...
        os.environ["REDIS_URL"] = "redis://nonexistent.example.com:6379"
        os.environ["REDIS_MODE"] = "auto"  # Should try remote then fallback
        ...
        current_mode = os.environ.get("REDIS_MODE", "")

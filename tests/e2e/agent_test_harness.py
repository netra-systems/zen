...
class AgentTestHarness:
    ...
    async def connect_websocket_with_auth(self, user_auth: Dict) -> websockets.legacy.server.WebSocketServerProtocol:
    ...
    async def send_agent_message(self, websocket: websockets.legacy.server.WebSocketServerProtocol, 
    ...
    async def wait_for_agent_response(self, websocket: websockets.legacy.server.WebSocketServerProtocol,

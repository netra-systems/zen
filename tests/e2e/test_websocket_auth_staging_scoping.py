...
""""""
        ...
        with patch('shared.isolated_environment.get_env', return_value=staging_environment):
            ...
            try:
                ...
                golden_path_validation = {'websocket_connection': True, 'authentication_success': True, 'user_context_created': True, 'e2e_context_valid': True, 'staging_environment_detected': True, 'scoping_bug_resolved': True}
...
""
        ...
        with patch('shared.isolated_environment.get_env', return_value=staging_agent_env):
            ...
            try:
                ...
                test_agent_events = [{'type': 'agent_started', 'agent_name': 'test_agent', 'user_id': user_context['user_id']}, {'type': 'agent_thinking', 'status': 'analyzing', 'progress': 25}, {'type': 'tool_executing', 'tool': 'search', 'query': 'test query'}, {'type': 'tool_completed', 'tool': 'search', 'results': ['result1', 'result2']}, {'type': 'agent_completed', 'result': 'Test agent execution completed'}]
        ...
        for iteration in range(5):
            ...
            with patch('shared.isolated_environment.get_env', return_value=staging_perf_env):
                try:
                    ...
                    context_time = (context_end - context_start) * 1000
...
""""""
        ...
        class RealGCPWebSocket:
            ...
            def __init__(self):
                ...
                self.client_state = 'CONNECTED'
                self.gcp_metadata = {'instance_id': 'staging-instance-12345', 'zone': 'us-central1-a', 'machine_type': 'e2-micro'}

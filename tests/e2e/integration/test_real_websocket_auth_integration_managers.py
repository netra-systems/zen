"""Test module: test_real_websocket_auth_integration_managers.py
...
class TestRealWebsocketAuthIntegrationManagers:
    """Test class for real_websocket_auth_integration_managers"""

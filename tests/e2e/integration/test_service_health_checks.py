...
async def _check_all_service_health(fixture: DevHealthFixtureTests) -> List[HealthCheckResult]:
...
async def _monitor_startup_health(fixture: DevHealthFixtureTests) -> List[Tuple[float, List[HealthCheckResult]]]:

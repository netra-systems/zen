...
def main():
    ...
    if args.test:
        cmd.append(f"tests/load/test_production_load_persistence.py::{args.test}")
    else:
    ...
    print(f"🚀 Starting production load tests...")
    ...
    try:
        ...
        print(f"📁 Test reports available in: {args.report_dir}")

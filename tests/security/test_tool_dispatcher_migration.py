...
class TestDeprecationWarnings:
    ...
    pass
        ...
        with pytest.warns(DeprecationWarning, match="ToolDispatcher.register_tool\\(\\) called on global instance"):
            dispatcher.register_tool("test_tool", lambda: "result", "Test tool")
...
class TestMigrationIntegration:
    ...
    async def test_concurrent_user_simulation(self):
        ...
        global_dispatcher.register_tool("user_data", lambda: "global_shared_data")
    ...
    pass
        ...
        with warnings.catch_warnings(record=True):
            ...
            dispatcher.register_tool("test_tool", lambda: "result")

...
**Generated:** 2025-08-21T11:06:45.761547  
...
|-----------|-------|--------|--------|---------|--------|----------|--------|
| Backend   | 0 | 0 | 0 | 0 | 0 | 3.38s | [FAILED] |
...
================================================================================
================================================================================
[FAIL] TESTS FAILED with exit code 4 after 2.75s
================================================================================
...
netra_backend\app\routes\mcp\main.py:24: in <module>
    from netra_backend.app.services.service_factory import get_mcp_service
E   ImportError: cannot import name 'get_mcp_service' from 'netra_backend.app.services.service_factory' (C:\Users\antho\OneDrive\Desktop\Netra\netra-core-generation-1\netra_backend\app\services\service_factory.py)

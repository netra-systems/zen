...
**Generated:** 2025-08-21T14:05:31.723495  
...
|-----------|-------|--------|--------|---------|--------|----------|--------|
| Backend   | 4 | 0 | 0 | 0 | 4 | 23.93s | [FAILED] |
...
Total Test Runs Analyzed: 162

================================================================================


=================================== ERRORS ====================================
[31m[1m_ ERROR collecting netra_backend/tests/integration/critical_paths/test_agent_context_isolation_boundaries_l3.py _[0m
...
[31mERROR[0m netra_backend/tests/integration/critical_paths/test_agent_context_isolation_boundaries_l3.py - Failed: 'L3' not found in `markers` configuration option
[31mERROR[0m netra_backend/tests/integration/critical_paths/test_agent_context_isolation_boundaries_l3.py - Failed: 'L3' not found in `markers` configuration option
[31mERROR[0m netra_backend/tests/integration/critical_paths/test_agent_context_isolation_boundaries_l3.py - Failed: 'L3' not found in `markers` configuration option
[31mERROR[0m netra_backend/tests/integration/critical_paths/test_agent_context_isolation_boundaries_l3.py - Failed: 'L3' not found in `markers` configuration option
[31m!!!!!!!!!!!!!!!!!!!!!!!!!! stopping after 4 failures !!!!!!!!!!!!!!!!!!!!!!!!!![0m
!!!!!!!!!!!! xdist.dsession.Interrupted: stopping after 1 failures !!!!!!!!!!!!
[31m============================= [31m[1m4 errors[0m[31m in 14.21s[0m[31m ==============================[0m
================================================================================
[FAIL] TESTS FAILED with exit code 2 after 22.59s
================================================================================

C:\Users\antho\OneDrive\Desktop\Netra\netra-core-generation-1\netra_backend\tests\integration\critical_paths\test_agent_communication_basic_l3.py:34: PytestCollectionWarning: cannot collect test class 'TestAgentCommunicationBasic' because it has a __init__ constructor (from: netra_backend/tests/integration/critical_paths/test_agent_communication_basic_l3.py)

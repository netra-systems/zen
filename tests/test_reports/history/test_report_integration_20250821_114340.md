...
**Generated:** 2025-08-21T11:28:07.797237  
...
| Frontend  | 69 | 11 | 58 | 0 | 0 | 55.29s | [FAILED] |
...
================================================================================
================================================================================
[FAIL] TESTS FAILED with exit code 4 after 4.40s
================================================================================
...
netra_backend\app\agents\supervisor\agent_registry.py:19: in <module>
    from netra_backend.app.agents.corpus_admin_sub_agent import CorpusAdminSubAgent
netra_backend\app\agents\corpus_admin_sub_agent.py:21: in <module>
    from netra_backend.app.agents.corpus_admin.agent import CorpusAdminSubAgent
netra_backend\app\agents\corpus_admin\__init__.py:8: in <module>
    from netra_backend.app.agents.corpus_admin.agent import CorpusAdminSubAgent
netra_backend\app\agents\corpus_admin\agent.py:33: in <module>
    from netra_backend.app.agents.corpus_admin.parsers import CorpusRequestParser
netra_backend\app\agents\corpus_admin\parsers.py:16: in <module>
...
E   ImportError: cannot import name 'CorpusOperation' from 'netra_backend.app.services.apex_optimizer_agent.models' (C:\Users\antho\OneDrive\Desktop\Netra\netra-core-generation-1\netra_backend\app\services\apex_optimizer_agent\models.py)
...
FAIL __tests__/integration/websocket-complete-refactored.test.tsx (53.18 s)
  ...
  ● WebSocket Connection Lifecycle Tests › Reconnection Scenarios › should handle real reconnection with timing simulation
    ...
    [31m[1m>[22m[39m[90m 169 |[39m           reject([36mnew[39m [33mError[39m([32m'Connection timeout'[39m))[33m;[39m
     ...
     [90m 172 |[39m           queueMicrotask(checkConnection)[33m;[39m[0m
      ...
      at checkConnection (__tests__/helpers/websocket-test-manager.ts:169:18)
      at invokeTheCallbackFunction (node_modules/jsdom/lib/jsdom/living/generated/Function.js:19:26)
      at node_modules/jsdom/lib/jsdom/b...(truncated)
```

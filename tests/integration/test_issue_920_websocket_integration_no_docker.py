...
class Issue920WebSocketIntegrationNoDockersTests(SSotBaseTestCase):
    ...
    def setup_method(self, method):
        ...
        # Test identifiers
        self.test_user_id = f"issue920_integration_user_{uuid.uuid4().hex[:8]}"
        self.test_thread_id = f"issue920_integration_thread_{uuid.uuid4().hex[:8]}"
        self.test_run_id = f"issue920_integration_run_{uuid.uuid4().hex[:8]}"
        self.test_session_id = f"issue920_integration_session_{uuid.uuid4().hex[:8]}"
    ...
    async def test_multi_user_websocket_integration_isolation(self):
        ...
        user2_id = f"issue920_integration_user2_{uuid.uuid4().hex[:8]}"
        ...
        user2_context.session_id = f"session2_{uuid.uuid4().hex[:8]}"
    ...
    def teardown_method(self, method):
        ...
        logger.info(
            f"Issue #920 Integration Test Metrics: {self.integration_metrics}"
        )

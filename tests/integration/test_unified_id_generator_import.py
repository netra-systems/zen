...
def test_agent_handler_handle_message_source_code():
    ...
    assert 'from shared.id_generation.unified_id_generator import UnifiedIdGenerator' not in source, 'UnifiedIdGenerator should NOT be imported inside the method (causes scope shadowing)'

...
class TestStartupCrossPhaseIntegration(BaseIntegrationTest):
    ...
    def __init__(self):
        ...
        self.startup_context: Optional[StartupContext] = None
    ...
    async def asyncTearDown(self):
        ...
        if self.startup_module:
            try:
                await self.startup_module.shutdown()
            except Exception:
    ...
    async def test_authentication_context_across_phases(self, real_services_fixture):
        ...
        try:
            ...
            context = await startup_module.execute_through_phase(StartupPhase.FINALIZE, context)
    ...
    async def test_cross_phase_event_propagation(self, real_services_fixture):
        ...
        try:
            ...
            if hasattr(startup_module, 'add_event_handler'):
                startup_module.add_event_handler(event_handler)
    ...
    async def test_multi_instance_phase_isolation(self, real_services_fixture):
        ...
        startup_module_2 = StartupModule()
        
        try:
            # Execute different phases on different instances
            context_1 = await startup_module_1.execute_through_phase(StartupPhase.DEPENDENCIES)
            ...
            await startup_module_1.shutdown()
            await startup_module_2.shutdown()
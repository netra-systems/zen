...
""
    ...
    def teardown_method(self):
        ...
        print(fThread ID changes: {len(self.context_tracking['thread_id_changes']})
        print(fRun ID changes: {len(self.context_tracking['run_id_changes']}")"
        print(fSession violations: {len(self.context_tracking['session_violations']})
...
""
    ...
    async def test_error_handling_maintains_context_consistency(self):
        ...
        assert post_error_context.thread_id == error_thread_id, \
            fError handling broke thread continuity! Expected {error_thread_id}, got {post_error_context.thread_id}
    ...
    async def test_context_creation_vs_getter_usage_patterns(self):
        ...
        print(fCorrect pattern run_id consistency: {correct_context_1.run_id == correct_context_2.run_id}")"

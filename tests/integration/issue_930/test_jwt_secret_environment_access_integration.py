...
class TestJWTSecretEnvironmentAccessIntegration:
    ...
    def test_multi_service_jwt_secret_isolation_failure(self):
        ...
        with ThreadPoolExecutor(max_workers=2) as executor:
            futures = [
                ...
                executor.submit(simulate_service_jwt_access, 'auth-staging')
            ]
        ...
        auth_secret = secrets_by_service.get('auth-staging')
    ...
    def test_staging_concurrent_service_startup_race_condition(self):
        ...
        services = ['backend-staging', 'auth-staging', 'websocket-staging']
        secrets = {}

...
class TestHttpApiWebSocketIndependence(SSotAsyncTestCase):
    ...
    def test_request_scoped_context_websocket_property_alias(self):
        ...
        # Test the property alias that fixes the original error
        ...
        # Verify the property alias works

        self.assertEqual(context.websocket_connection_id, "test_websocket_id")



        # Verify both attributes point to same value
    ...
    def test_http_api_agent_execute_without_service(self, mock_get_service):
        ...
        # Mock AgentService as unavailable (returns None)
        ...
        response = self.client.post("/api/agents/execute", json={

            "type": "triage",

            "message": "Test message without WebSocket"

        })



        # Should succeed with degraded mode response
    ...
    def test_http_api_specific_agents_fallback(self, mock_get_service):
        ...
        # Test each specific agent endpoint
        ...
        for agent_type in agent_types:
            ...
            with self.subTest(agent_type=agent_type):
                ...
                response = self.client.post(f"/api/agents/{agent_type}", json={

                    "message": f"Test {agent_type} without WebSocket"
    ...
    def test_http_api_control_endpoints_fallback(self, mock_get_service):
        ...
        response = self.client.post("/api/agents/start", json={

            "agent_type": "triage",

            "message": "Test start without WebSocket"
        ...
        response = self.client.post("/api/agents/stop", json={
        ...
        response = self.client.post("/api/agents/cancel", json={
    ...
    def test_http_api_status_endpoint_fallback(self, mock_get_service):
        ...
        # Test status endpoint - all agents
        ...
        # Test status endpoint - specific agent
    ...
    def test_http_api_streaming_fallback(self, mock_get_service):
        ...
        response = self.client.post("/api/agents/stream", json={

            "agent_type": "triage",

            "message": "Test streaming without WebSocket"

        })



        # Should return server-sent events
        ...
        # Verify streaming content has expected events
    ...
    async def test_agent_service_fallback_execution(self, mock_agent_service_class):
        ...
        # Mock supervisor for fallback execution
        ...
        # Mock bridge as not ready to force fallback path
        ...
        result = await service._execute_agent_fallback(

            agent_type="triage",

            message="Test fallback execution",
        ...
        # Verify fallback execution called supervisor directly
    ...
    def test_get_request_scoped_user_context_websocket_parameter_mapping(self):
        ...
        # Test parameter name mapping: websocket_connection_id -> websocket_client_id

        context = get_request_scoped_user_context_http_api(
        ...
        self.assertEqual(context.websocket_connection_id, "test_connection_id")  # Property alias

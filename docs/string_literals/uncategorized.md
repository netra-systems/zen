...
| `    <metadata>` | split_learnings_robust.py:84 | create_index | `.github`, `.act.secrets` |
...
| `   Status: ` | force_cancel_workflow.py:86 | _print_run_info | `.github`, `.act.secrets` |
...
| `  Total: ` | generate_performance_report.py:180 | print_summary | `.github`, `.act.secrets` |
...
| ` Missing: ` | analyze_coverage.py:26 | module | `.github`, `.act.secrets` |
...
| `"state"` | auth_constants_migration.py:76 | AuthConstantsMigrator.__init__ | `.github`, `.act.secrets` |
...
| `\.\.\.` | reset_clickhouse.py:112 | connect_to_clickhouse | `.github`, `.act.secrets` |
...
| `\.1f` | cleanup_generated_files.py:203 | print_scan_summary | `.github`, `.act.secrets` |
...
| `\.act\.secrets` | local_secrets_manager.py:34 | LocalSecretsManager._ensure... | `.github`, `utf-8` |
...
| `\.js` | metadata_header_generator.py:175 | MetadataHeaderGenerator.get... | `.github`, `.act.secrets` |
...
| `\.tsx` | auto_split_files.py:46 | FileSplitter.analyze_file_f... | `.github`, `.act.secrets` |
...
| `:us\-central1:netra\-postgres` | deploy_to_gcp.py:494 | GCPDeployer.deploy_service | `.github`, `.act.secrets` |
...
| `app\.` | check_netra_backend_imports.py:158 | ImportAnalyzer._check_import | `.github`, `.act.secrets` |
...
| `Auth: ` | validate_jwt_consistency.py:88 | validate_jwt_secret_consist... | `.github`, `.act.secrets` |
...
| `e2e\.` | e2e_import_fixer_comprehensive.py:335 | E2EImportFixer._suggest_fix... | `.github`, `.act.secrets` |
...
| `Fixing: ` | fix_remaining_syntax_errors.py:211 | main | `.github`, `.act.secrets` |
...
| `HEAD@\{` | team_updates_sync.py:15 | get_top_changed_files | `.github`, `.act.secrets` |
...
| `netra\-assistant` | setup_assistant.py:44 | _check_existing_assistant | `.github`, `.act.secrets` |
...
| `pre\-commit` | git_hooks_manager.py:39 | GitHooksManager._install_pr... | `.github`, `.act.secrets` |
...
| `search\-patterns` | markdown_reporter.py:263 | MarkdownReporter._generate_... | `.github`, `.act.secrets` |
...
| `tests\.unified\.` | e2e_import_fixer_comprehensive.py:334 | E2EImportFixer._suggest_fix... | `.github`, `.act.secrets` |
...
| `utf\-8` | auth_constants_migration.py:188 | AuthConstantsMigrator.migra... | `.github`, `.act.secrets` |
...
| `utf\-8` | comprehensive_e2e_import_fixer.py:46 | ComprehensiveE2EImportFixer... | `.github`, `.act.secrets` |
...
| `utf\-8` | fast_import_checker.py:160 | fix_known_import_issues | `.github`, `.act.secrets` |
...
| `utf\-8` | fix_boolean_comparisons.py:28 | fix_boolean_comparisons | `.github`, `.act.secrets` |
| `utf\-8` | fix_comprehensive_imports.py:54 | ComprehensiveImportFixerV2.... | `.github`, `.act.secrets` |
| `utf\-8` | fix_comprehensive_imports.py:115 | ComprehensiveImportFixerV2.... | `.github`, `.act.secrets` |
| `utf\-8` | fix_comprehensive_imports.py:131 | ComprehensiveImportFixerV2.... | `.github`, `.act.secrets` |
| `utf\-8` | fix_comprehensive_imports.py:154 | ComprehensiveImportFixerV2.... | `.github`, `.act.secrets` |
| `utf\-8` | fix_comprehensive_imports.py:170 | ComprehensiveImportFixerV2.... | `.github`, `.act.secrets` |
| `utf\-8` | fix_comprehensive_imports.py:186 | ComprehensiveImportFixerV2.... | `.github`, `.act.secrets` |
| `utf\-8` | fix_comprehensive_imports.py:202 | ComprehensiveImportFixerV2.... | `.github`, `.act.secrets` |
| `utf\-8` | fix_comprehensive_imports.py:225 | ComprehensiveImportFixerV2.... | `.github`, `.act.secrets` |
| `utf\-8` | fix_datetime_deprecation.py:11 | fix_datetime_in_file | `.github`, `.act.secrets` |
| `utf\-8` | fix_datetime_deprecation.py:54 | fix_datetime_in_file | `.github`, `.act.secrets` |
| `utf\-8` | fix_double_modern.py:9 | fix_file | `.github`, `.act.secrets` |
| `utf\-8` | fix_double_modern.py:22 | fix_file | `.github`, `.act.secrets` |
| `utf\-8` | fix_e2e_imports.py:105 | E2EImportFixer.fix_file | `.github`, `.act.secrets` |
| `utf\-8` | fix_e2e_imports.py:163 | E2EImportFixer.fix_file | `.github`, `.act.secrets` |
| `utf\-8` | fix_embedded_setup_imports.py:138 | EmbeddedSetupImportFixer.pr... | `.github`, `.act.secrets` |
| `utf\-8` | fix_embedded_setup_imports.py:154 | EmbeddedSetupImportFixer.pr... | `.github`, `.act.secrets` |
| `utf\-8` | fix_frontend_tests.py:108 | _cleanup_and_write_file | `.github`, `.act.secrets` |
| `utf\-8` | fix_imports.py:115 | ImportFixer.fix_file | `.github`, `.act.secrets` |
| `utf\-8` | fix_imports.py:175 | ImportFixer.fix_file | `.github`, `.act.secrets` |
| `utf\-8` | fix_imports.py:206 | ImportFixer.fix_duplicate_i... | `.github`, `.act.secrets` |
| `utf\-8` | fix_imports.py:228 | ImportFixer.fix_duplicate_i... | `.github`, `.act.secrets` |
| `utf\-8` | fix_import_indents.py:10 | fix_import_indents | `.github`, `.act.secrets` |
| `utf\-8` | fix_import_indents.py:44 | fix_import_indents | `.github`, `.act.secrets` |
| `utf\-8` | fix_import_issues.py:20 | fix_validate_token_imports | `.github`, `.act.secrets` |
| `utf\-8` | fix_import_issues.py:40 | fix_validate_token_imports | `.github`, `.act.secrets` |
| `utf\-8` | fix_import_issues.py:52 | fix_websockets_import | `.github`, `.act.secrets` |
| `utf\-8` | fix_import_issues.py:80 | fix_websockets_import | `.github`, `.act.secrets` |
| `utf\-8` | fix_import_syntax_errors.py:16 | fix_import_syntax_in_file | `.github`, `.act.secrets` |
| `utf\-8` | fix_import_syntax_errors.py:99 | fix_import_syntax_in_file | `.github`, `.act.secrets` |
| `utf\-8` | fix_malformed_imports.py:180 | MalformedImportFixer.proces... | `.github`, `.act.secrets` |
| `utf\-8` | fix_malformed_imports.py:196 | MalformedImportFixer.proces... | `.github`, `.act.secrets` |
| `utf\-8` | fix_netra_backend_imports.py:67 | ImportFixer.fix_file | `.github`, `.act.secrets` |
| `utf\-8` | fix_netra_backend_imports.py:96 | ImportFixer.fix_file | `.github`, `.act.secrets` |
| `utf\-8` | fix_netra_domain.py:14 | fix_domain_in_file | `.github`, `.act.secrets` |
| `utf\-8` | fix_netra_domain.py:31 | fix_domain_in_file | `.github`, `.act.secrets` |
| `utf\-8` | fix_remaining_e2e_imports.py:12 | fix_file | `.github`, `.act.secrets` |
| `utf\-8` | fix_remaining_e2e_imports.py:19 | fix_file | `.github`, `.act.secrets` |
| `utf\-8` | fix_remaining_e2e_imports.py:170 | create_missing_helpers | `.github`, `.act.secrets` |
| `utf\-8` | fix_remaining_imports.py:9 | fix_import_indents | `.github`, `.act.secrets` |
| `utf\-8` | fix_remaining_imports.py:34 | fix_import_indents | `.github`, `.act.secrets` |
| `utf\-8` | fix_remaining_syntax_errors.py:146 | check_syntax | `.github`, `.act.secrets` |
| `utf\-8` | fix_remaining_syntax_errors.py:158 | fix_file | `.github`, `.act.secrets` |
| `utf\-8` | fix_remaining_syntax_errors.py:171 | fix_file | `.github`, `.act.secrets` |
| `utf\-8` | fix_schema_imports.py:62 | SchemaImportFixer._move_sch... | `.github`, `.act.secrets` |
| `utf\-8` | fix_schema_imports.py:68 | SchemaImportFixer._move_sch... | `.github`, `.act.secrets` |
| `utf\-8` | fix_schema_imports.py:101 | SchemaImportFixer._move_sch... | `.github`, `.act.secrets` |
| `utf\-8` | fix_schema_imports.py:107 | SchemaImportFixer._move_sch... | `.github`, `.act.secrets` |
| `utf\-8` | fix_schema_imports.py:120 | SchemaImportFixer.fix_impor... | `.github`, `.act.secrets` |
| `utf\-8` | fix_schema_imports.py:145 | SchemaImportFixer.fix_impor... | `.github`, `.act.secrets` |
| `utf\-8` | fix_schema_imports.py:192 | SchemaImportFixer.update_in... | `.github`, `.act.secrets` |
| `utf\-8` | fix_schema_imports.py:221 | SchemaImportFixer.update_in... | `.github`, `.act.secrets` |
| `utf\-8` | fix_schema_imports.py:296 | main | `.github`, `.act.secrets` |
| `utf\-8` | fix_supervisor_imports.py:25 | fix_supervisor_imports | `.github`, `.act.secrets` |
| `utf\-8` | fix_supervisor_imports.py:45 | fix_supervisor_imports | `.github`, `.act.secrets` |
| `utf\-8` | fix_supervisor_imports.py:75 | find_files_with_bad_imports | `.github`, `.act.secrets` |
| `utf\-8` | fix_warp_runners.py:21 | update_runners | `.github`, `.act.secrets` |
| `utf\-8` | fix_warp_runners.py:28 | update_runners | `.github`, `.act.secrets` |
| `utf\-8` | fix_workflow_env_issues.py:56 | process_workflow_file | `.github`, `.act.secrets` |
| `utf\-8` | fix_workflow_env_issues.py:67 | process_workflow_file | `.github`, `.act.secrets` |
| `utf\-8` | function_complexity_analyzer.py:190 | FunctionComplexityAnalyzer.... | `.github`, `.act.secrets` |
| `utf\-8` | function_complexity_analyzer.py:373 | main | `.github`, `.act.secrets` |
| `utf\-8` | function_complexity_linter.py:88 | FunctionComplexityLinter._p... | `.github`, `.act.secrets` |
| `utf\-8` | generate_openapi_spec.py:125 | save_spec_to_file | `.github`, `.act.secrets` |
| `utf\-8` | generate_openapi_spec.py:143 | read_spec_file | `.github`, `.act.secrets` |
| `utf\-8` | generate_wip_report.py:190 | WIPReportGenerator.generate... | `.github`, `.act.secrets` |
| `utf\-8` | identify_violations.py:19 | analyze_file | `.github`, `.act.secrets` |
| `utf\-8` | import_management.py:87 | ImportManagementSystem.chec... | `.github`, `.act.secrets` |
| `utf\-8` | import_management.py:221 | ImportManagementSystem.gene... | `.github`, `.act.secrets` |
| `utf\-8` | import_management.py:226 | ImportManagementSystem.gene... | `.github`, `.act.secrets` |
| `utf\-8` | metadata_header_generator.py:267 | MetadataHeaderGenerator.add... | `.github`, `.act.secrets` |
| `utf\-8` | metadata_header_generator.py:292 | MetadataHeaderGenerator.add... | `.github`, `.act.secrets` |
| `utf\-8` | report_generator.py:186 | ReportGenerator.save_report | `.github`, `.act.secrets` |
| `utf\-8` | scan_string_literals.py:245 | StringLiteralIndexer.save_i... | `.github`, `.act.secrets` |
| `utf\-8` | scan_string_literals_enhanced.py:249 | EnhancedStringLiteralIndexe... | `.github`, `.act.secrets` |
| `utf\-8` | schema_sync.py:123 | validate_typescript_output | `.github`, `.act.secrets` |
| `utf\-8` | split_learnings.py:20 | parse_learnings | `.github`, `.act.secrets` |
| `UTF\-8` | split_learnings.py:82 | create_category_file | `.github`, `.act.secrets` |
| `UTF\-8` | split_learnings.py:116 | create_index | `.github`, `.act.secrets` |
| `utf\-8` | split_learnings_robust.py:75 | create_category_file | `.github`, `.act.secrets` |
| `utf\-8` | split_learnings_robust.py:124 | create_index | `.github`, `.act.secrets` |
| `utf\-8` | split_learnings_robust.py:135 | main | `.github`, `.act.secrets` |
| `utf\-8` | status_agent_analyzer.py:124 | AgentSystemAnalyzer._read_f... | `.github`, `.act.secrets` |
| `utf\-8` | status_integration_analyzer.py:172 | IntegrationAnalyzer._read_f... | `.github`, `.act.secrets` |
| `utf\-8` | markdown_reporter.py:639 | MarkdownReporter._generate_... | `.github`, `.act.secrets` |
| `utf\-8` | scanner_core.py:107 | scan_file | `.github`, `.act.secrets` |
| `utf\-8` | team_updates.py:78 | main | `.github`, `.act.secrets` |
| `utf\-8` | team_updates_sync.py:77 | generate_simple_report | `.github`, `.act.secrets` |
| `utf\-8` | team_updates_sync.py:173 | main | `.github`, `.act.secrets` |
| `utf\-8` | unified_import_manager.py:353 | UnifiedImportManager._check... | `.github`, `.act.secrets` |
| `utf\-8` | unified_import_manager.py:500 | UnifiedImportManager.save_r... | `.github`, `.act.secrets` |
| `utf\-8` | update_spec_timestamps.py:192 | add_timestamp_to_xml | `.github`, `.act.secrets` |
| `utf\-8` | update_spec_timestamps.py:230 | main | `.github`, `.act.secrets` |
| `utf\-8` | validate_service_independence.py:66 | ServiceIndependenceValidato... | `.github`, `.act.secrets` |
| `utf\-8` | validate_type_deduplication.py:138 | TypeDeduplicationValidator.... | `.github`, `.act.secrets` |
| `utf\-8` | validate_type_deduplication.py:186 | TypeDeduplicationValidator.... | `.github`, `.act.secrets` |
| `utf\-8` | websocket_coherence_review.py:116 | check_payload_completeness | `.github`, `.act.secrets` |
| `utf\-8` | websocket_coherence_review.py:449 | main | `.github`, `.act.secrets` |
| `v1\.0` | generate_openapi_spec.py:212 | sync_to_readme | `.github`, `.act.secrets` |
| `v1\.0` | generate_openapi_spec.py:306 | _add_readme_args | `.github`, `.act.secrets` |
| `v1\.2\.3` | demo_enhanced_categorizer.py:109 | categorize_specific_examples | `.github`, `.act.secrets` |
| `v1\.2\.3` | metadata_header_generator.py:33 | MetadataHeaderGenerator._ge... | `.github`, `.act.secrets` |
| `validate\_token: ` | fix_import_issues.py:155 | main | `.github`, `.act.secrets` |
| `validate\_token: ` | unified_import_manager.py:406 | UnifiedImportManager._fix_s... | `.github`, `.act.secrets` |
| `warp\-custom\-default` | fix_warp_runners.py:23 | update_runners | `.github`, `.act.secrets` |
| `WebSocketProvider\.tsx` | status_integration_analyzer.py:76 | IntegrationAnalyzer._check_... | `.github`, `.act.secrets` |
| `win32` | benchmark_optimization.py:435 | module | `.github`, `.act.secrets` |
| `win32` | build_staging.py:13 | module | `.github`, `.act.secrets` |
| `win32` | deploy_to_gcp.py:27 | module | `.github`, `.act.secrets` |
| `win32` | deploy_to_gcp.py:59 | GCPDeployer.__init__ | `.github`, `.act.secrets` |
| `win32` | deploy_to_gcp.py:61 | GCPDeployer.__init__ | `.github`, `.act.secrets` |
| `win32` | dev_launcher_processes.py:208 | create_backend_process | `.github`, `.act.secrets` |
| `win32` | dev_launcher_processes.py:232 | create_frontend_process | `.github`, `.act.secrets` |
| `win32` | dev_launcher_processes.py:263 | cleanup_process | `.github`, `.act.secrets` |
| `win32` | dev_launcher_service.py:191 | ServiceManager._build_front... | `.github`, `.act.secrets` |
| `win32` | setup_import_hooks.py:49 | setup_pre_commit_hook | `.github`, `.act.secrets` |
| `X\-API\-Key` | generate_openapi_spec.py:103 | _get_security_schemes | `.github`, `.act.secrets` |
| `X\-Content\-Type\-Options` | validate_staging_health.py:231 | StagingSecurityValidator._c... | `.github`, `.act.secrets` |
| `X\-Frame\-Options` | validate_staging_health.py:232 | StagingSecurityValidator._c... | `.github`, `.act.secrets` |
| `X\-GitHub\-Api\-Version` | force_cancel_workflow.py:17 | get_workflow_runs | `.github`, `.act.secrets` |
| `X\-GitHub\-Api\-Version` | force_cancel_workflow.py:34 | force_cancel_workflow | `.github`, `.act.secrets` |
| `x\-readme\-version` | generate_openapi_spec.py:151 | create_readme_headers | `.github`, `.act.secrets` |
| `x\-readme\-version` | generate_openapi_spec.py:184 | upload_spec_to_readme | `.github`, `.act.secrets` |
| `XXX:` | architecture_scanner_helpers.py:131 | ScannerHelpers.get_debt_pat... | `.github`, `.act.secrets` |
| `\|\-\-\-\-\-\-\-\-\-\-\|\-\-\-\-\-\-\...` | markdown_reporter.py:618 | MarkdownReporter._generate_... | `.github`, `.act.secrets` |
| `\|\-\-\-\-\-\-\-\-\-\|\-\-\-\-\-\-\-\...` | markdown_reporter.py:296 | MarkdownReporter._generate_... | `.github`, `.act.secrets` |
| `\|\-\-\-\-\-\-\-\-\-\|\-\-\-\-\-\-\-\...` | markdown_reporter.py:477 | MarkdownReporter._generate_... | `.github`, `.act.secrets` |
| `\|\-\-\-\-\-\-\-\-\|\-\-\-\-\-\-\-\|` | generate_performance_report.py:32 | add_summary_section | `.github`, `.act.secrets` |
| `\|\-\-\-\-\-\-\-\-\|\-\-\-\-\-\-\-\|` | markdown_reporter.py:237 | MarkdownReporter._generate_... | `.github`, `.act.secrets` |
| `\|\-\-\-\-\-\-\-\-\|\-\-\-\-\-\-\-\|` | markdown_reporter.py:423 | MarkdownReporter._generate_... | `.github`, `.act.secrets` |
| `\|\-\-\-\-\-\-\|\-\-\-\-\-\-\-\|\-\-\...` | generate_performance_report.py:53 | add_performance_issues | `.github`, `.act.secrets` |
| `⚙️` | markdown_reporter.py:32 | MarkdownReporter.__init__ | `.github`, `.act.secrets` |
| `🏷️` | markdown_reporter.py:34 | MarkdownReporter.__init__ | `.github`, `.act.secrets` |
| `🗄️` | markdown_reporter.py:35 | MarkdownReporter.__init__ | `.github`, `.act.secrets` |
| `🛤️` | markdown_reporter.py:33 | MarkdownReporter.__init__ | `.github`, `.act.secrets` |

### Usage Examples

- **scripts\compliance\find_top_mocks.py:149** - `main`
- **scripts\split_large_files.py:236** - `_display_split_suggestions`
- **scripts\split_large_files.py:237** - `_display_split_suggestions`
...
*This is the detailed documentation for the `uncategorized` category.*

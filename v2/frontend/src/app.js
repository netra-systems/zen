...
import { Google, Zap, Settings, RefreshCw, BarChart2, DollarSign, Clock, HelpCircle } from 'lucide-react';
...
const LoginPage = () => (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center">
        ...
        <div className="mt-8">
            <Button onClick={() => window.location.href = '/login/google'} icon={Google} variant="secondary">
                Sign in with Google
            </Button>
        </div>
    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16">
                        ...
                        <div className="flex items-center">
                            ...
                            <a href="/logout" className="text-sm font-medium text-gray-500 hover:text-gray-700">Logout</a>
                        </div>
                    </div>
                </div>
            </nav>
...
const AnalysisResultView = ({ analysisRun }) => {
    if (!analysisRun) {
        return (
    ...
    if (analysisRun.status === 'completed' && analysisRun.result_summary) {
        ...
        return (
            <Card>
                ...
                {/* Placeholder for detailed pattern view */}
                <div className="mt-8">

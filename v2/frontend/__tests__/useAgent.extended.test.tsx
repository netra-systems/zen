...
describe('useAgent - Extended Message Parsing', () => {
  ...
  it('should correctly parse and process various message types', async () => {
    ...
    const messages = [
      ...
      { event: 'on_chat_model_stream', data: { chunk: "content='' additional_kwargs={'function_call': {'name': 'cost_analyzer', 'arguments': '{}'}} response_metadata={'finish_reason': 'STOP', 'model_name': 'gemini-2.5-pro', 'safety_ratings': []} id='run--9fb39c87-3029-4a31-967b-97bcfe64efe3' tool_calls=[{'name': 'cost_analyzer', 'args': {}, 'id': '60e57d84-7c6b-47e2-ba52-90cb2fe6d52b', 'type': 'tool_call'}] usage_metadata={'output_token_details': {'reasoning': 0}, 'output_tokens': 10, 'input_tokens': 0, 'input_token_details': {'cache_read': 0}, 'total_tokens': 10} tool_call_chunks=[{'name': 'cost_analyzer', 'args': '{}', 'id': '60e57d84-7c6b-47e2-ba52-90cb2fe6d52b', 'index': null, 'type': 'tool_call_chunk'}]" } },

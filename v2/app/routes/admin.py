...
async def get_app_settings(current_user: schemas.User = Depends(ActiveUserWsDep)):
    """
...
async def set_log_table(data: schemas.LogTableSettings, current_user: schemas.User = Depends(ActiveUserWsDep)):
    """
...
async def add_log_table(data: schemas.LogTableSettings, current_user: schemas.User = Depends(ActiveUserWsDep)):
    """
...
async def remove_log_table(data: schemas.LogTableSettings, current_user: schemas.User = Depends(ActiveUserWsDep)):
    """
...
async def set_time_period(data: schemas.TimePeriodSettings, current_user: schemas.User = Depends(ActiveUserWsDep)):
    """
...
async def set_default_log_table_for_context(data: schemas.DefaultLogTableSettings, current_user: schemas.User = Depends(ActiveUserWsDep)):
    """
...
async def remove_default_log_table_for_context(data: schemas.DefaultLogTableSettings, current_user: schemas.User = Depends(ActiveUserWsDep)):
    """

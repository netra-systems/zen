...
async def set_log_table(log_table: str, current_user: User = Depends(get_current_active_user)):
    """
...
async def add_log_table(log_table: str, current_user: User = Depends(get_current_active_user)):
    """
...
async def remove_log_table(log_table: str, current_user: User = Depends(get_current_active_user)):
    """
...
async def set_time_period(days: int, current_user: User = Depends(get_current_active_user)):
    """
...
async def set_default_log_table_for_context(context: str, log_table: str, current_user: User = Depends(get_current_active_user)):
    """
...
async def remove_default_log_table_for_context(context: str, current_user: User = Depends(get_current_active_user)):
    """

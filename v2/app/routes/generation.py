...
class GenerationRoutes:
    ...
    async def create_content_corpus(self, params: ContentGenParams, background_tasks: BackgroundTasks) -> Dict[str, str]:
    ...
    async def create_synthetic_logs(self, params: LogGenParams, background_tasks: BackgroundTasks) -> Dict[str, str]:
    ...
    async def create_content_corpus_and_store(self, params: ContentCorpusGenParams, background_tasks: BackgroundTasks) -> Dict[str, str]:
    ...
    async def ingest_data(self, params: DataIngestionParams, background_tasks: BackgroundTasks) -> Dict[str, str]:
    ...
    async def create_synthetic_data(self, params: SyntheticDataGenParams, background_tasks: BackgroundTasks) -> Dict[str, str]:
    ...
    @router.get("/content")
    def list_content_corpuses(self) -> List[Dict]:
    ...
    @router.get("/logs")
    def list_log_sets(self) -> List[Dict]:

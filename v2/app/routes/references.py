...
class ReferenceRoutes:
    ...
    async def get_references(self, db: AsyncSession = Depends(get_db_session)) -> ReferenceGetResponse:
        """
    ...
    async def get_reference(self, reference_id: int, db: AsyncSession = Depends(get_db_session)) -> ReferenceItem:
        """
    ...
    async def create_reference(self, reference: ReferenceCreateRequest, db: AsyncSession = Depends(get_db_session)) -> ReferenceItem:
        """
    ...
    async def update_reference(self, reference_id: int, reference: ReferenceUpdateRequest, db: AsyncSession = Depends(get_db_session)) -> ReferenceItem:
        """

...
def settings_override():
    ...
    yield
    settings.clickhouse_logging.available_tables = original_tables
    settings.clickhouse_logging.default_table = original_default_table
    settings.clickhouse_logging.default_tables = original_default_tables

...
class SecurityService:
    ...
    async def create_user(self, db_session: AsyncSession, user_create: schemas.UserCreate) -> models_postgres.User:
    ...
    async def get_or_create_user_from_oauth(self, db_session: AsyncSession, user_info: dict) -> models_postgres.User:

...
try:
    subprocess.check_call([sys.executable, "-m", "pip", "install", "pydantic-to-typescript"])
    print("pydantic-to-typescript installed successfully")
except subprocess.CalledProcessError as e:
    print(f"Failed to install pydantic-to-typescript: {e}")
    sys.exit(1)
...
try:
    ...
    print("Successfully imported generate_typescript_defs")
except ImportError:
    print("Failed to import generate_typescript_defs")

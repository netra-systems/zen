...
|-----------|--------|----------|------|
| test_basic_functionality | PASS passed | 0.285s | test_10_critical_path_staging.py |
| test_critical_api_endpoints | PASS passed | 0.819s | test_10_critical_path_staging.py |

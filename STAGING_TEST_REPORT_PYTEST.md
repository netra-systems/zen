...
|-----------|--------|----------|------|
| test_basic_functionality | PASS passed | 0.274s | test_4_agent_orchestration_staging.py |
| test_agent_discovery_and_listing | PASS passed | 0.295s | test_4_agent_orchestration_staging.py |

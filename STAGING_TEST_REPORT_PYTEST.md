...
|-----------|--------|----------|------|
| test_basic_functionality | PASS passed | 0.422s | test_10_critical_path_staging.py |
| test_critical_api_endpoints | PASS passed | 5.884s | test_10_critical_path_staging.py |

...
async def _process_server_registration(
    request: RegisterServerRequest, mcp_service: IMCPClientService
...
async def _process_server_connection(
    server_name: str, mcp_service: IMCPClientService
...
async def _process_tool_discovery(
    server_name: str, mcp_service: IMCPClientService
...
async def _process_tool_execution(
    request: ExecuteToolRequest, mcp_service: IMCPClientService
) -> ExecuteToolResponse:
...
async def _process_resource_listing(
    server_name: str, mcp_service: IMCPClientService
...
async def _process_resource_fetching(
    request: FetchResourceRequest, mcp_service: IMCPClientService
...
async def _process_cache_clearing(
    server_name: Optional[str], mcp_service: IMCPClientService
) -> ClearCacheResponse:

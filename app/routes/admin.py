...
async def set_log_table(data: schemas.LogTableSettings, current_user: schemas.User = ActiveUserDep) -> Dict[str, str]:
    """
...
async def add_log_table(data: schemas.LogTableSettings, current_user: schemas.User = ActiveUserDep) -> Dict[str, str]:
    """
...
async def remove_log_table(data: schemas.LogTableSettings, current_user: schemas.User = ActiveUserDep) -> Dict[str, str]:
    """
...
async def set_time_period(data: schemas.TimePeriodSettings, current_user: schemas.User = ActiveUserDep) -> Dict[str, str]:
    """
...
async def set_default_log_table_for_context(data: schemas.DefaultLogTableSettings, current_user: schemas.User = ActiveUserDep) -> Dict[str, str]:
    """
...
async def remove_default_log_table_for_context(data: schemas.DefaultLogTableSettings, current_user: schemas.User = ActiveUserDep) -> Dict[str, str]:
    """

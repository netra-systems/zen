...
def _create_cost_optimization_steps() -> List[PlanStep]:
    ...
    from app.tests.e2e.data.plan_step_definitions import create_remaining_cost_steps
    base_steps = [
...
def _create_performance_tuning_steps() -> List[PlanStep]:
    ...
    from app.tests.e2e.data.plan_step_definitions import create_all_performance_steps
    return create_all_performance_steps()


def _create_capacity_planning_steps() -> List[PlanStep]:
    """Create capacity planning plan steps."""
    from app.tests.e2e.data.plan_step_definitions import create_all_capacity_steps

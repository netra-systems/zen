"""Test module: test_websocket_resilience_integration_performance.py
...
class TestWebsocketResilienceIntegrationPerformance:
    """Test class for websocket_resilience_integration_performance"""

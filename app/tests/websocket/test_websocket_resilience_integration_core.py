"""Test module: test_websocket_resilience_integration_core.py
...
class TestWebsocketResilienceIntegrationCore:
    """Test class for websocket_resilience_integration_core"""

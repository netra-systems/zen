...
class TestAPIRequestValidation:
    ...
    def test_generation_request_validation(self):
        ...
        try:
            ...
            assert request.prompt == "Generate optimization recommendations"
...
class TestAPIResponseValidation:
    ...
    def test_generation_response_structure(self):
        ...
        response_data = {
            "id": "gen123",
            "content": "Based on analysis, here are optimization recommendations...",
            "model": "gpt-4",
            "tokens_used": 250,
            "metadata": {
                "processing_time": 1.5,
        ...
        try:
            ...
            pytest.fail(f"Generation response validation failed: {e}")

...
from app.services.quality_gate_service import ContentType, QualityLevel, QualityMetrics
from app.tests.helpers.quality_monitoring_fixtures import (
    service_with_mocks,
    minimal_quality_metrics
)
from app.tests.helpers.quality_monitoring_helpers import (

...
from ... import schemas
from .base import CorpusStatus, CorpusNotFoundError, ClickHouseOperationError
...
class CorpusCrudService(BaseCorpusService):
    ...
    async def _get_corpus_for_delete(self, db: Session, 
    ...
    async def _execute_corpus_deletion(self, db: Session, corpus_id: str, 
    ...
    async def _handle_deletion_failure(self, db: Session, corpus_id: str, 
                                     e: Exception) -> None:
    ...
    async def _get_and_validate_source_corpus(self, db: Session, 
    ...
    async def _create_cloned_corpus_record(self, db: Session, 
    ...
    def _schedule_clone_operations(self, source_corpus: models.Corpus, 
                                 new_corpus: models.Corpus, db: Session) -> None:
    ...
    def _schedule_table_creation(self, new_corpus: models.Corpus, db: Session) -> None:

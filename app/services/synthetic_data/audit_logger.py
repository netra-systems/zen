...
class SyntheticDataAuditLogger:
    ...
    async def log_generation_with_audit(
        self, result: Dict, job_id: str, user_id: str, db: Optional[Session]
    ) -> None:
    ...
    async def _log_to_database(
        self, db: Session, result: Dict, job_id: str, user_id: str
    ) -> None:
    ...
    async def get_audit_logs_for_job(
        self, job_id: str, db: Optional[Session]
    ) -> List[Dict]:
    ...
    async def _get_database_audit_logs(self, db: Session, job_id: str) -> List[Dict]:

...
from .response_generator import generate_demo_response
from .metrics_generator import (generate_optimization_metrics, calculate_roi,
                               generate_synthetic_metrics)
from .template_manager import get_industry_templates

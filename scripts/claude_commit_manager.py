...
class ClaudeCommitManager:
    ...
    def __init__(self):
        ...
        self.bypass_patterns = [
            ...
            "WIP:",
            "TEMP:",
            "🤖 Generated with [Claude Code]"  # Already generated by Claude
        ]
...
Output ONLY the commit message, no explanation or markdown formatting."""
            ...
            print("⏱️ Claude Code timeout - using fallback")
    ...
    def run(self, existing_message: Optional[str] = None) -> str:
        ...
        if should_bypass:
            print(f"ℹ️ Claude commit helper bypassed: {bypass_reason}")
        ...
        print("🤖 Generating commit message with Claude Code...")

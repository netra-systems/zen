...
class PostgreSQLSecretsMigrator:
    ...
    def migrate_postgres_secrets(self):
        ...
        if fail_count == 0:
            ...
            print("\nNext steps:")
            print("1. Deploy the updated services: python scripts/deploy_to_gcp.py --project netra-staging --build-local")
            print("2. Verify connectivity: python scripts/validate_staging_db_connection.py")
        else:
...
def main():
    ...
    print("PostgreSQL Secrets Migration Tool (Automatic)")
    print("==============================================")

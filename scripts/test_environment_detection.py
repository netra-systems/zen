...
def test_auth_client_environment_detection():
    ...
    from app.clients.auth_client_config import EnvironmentDetector, Environment
...
def test_oauth_config_fallback():
    ...
    os.environ.pop("ENVIRONMENT", None)
    from app.clients.auth_client_config import OAuthConfigGenerator, EnvironmentDetector, Environment

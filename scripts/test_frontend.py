...
def show_deprecation_warning():
    ...
    print("="*80)
    print("The test_frontend.py script has been consolidated into unified_test_runner.py")
    print("Please update your scripts and CI/CD to use:")
    print()
    print("    python tests/unified_test_runner.py --service frontend [your args]")
    print()
...
def convert_args_to_unified(args):
    """Convert legacy frontend args to unified test runner args."""
    unified_args = ["python", "tests/unified_test_runner.py", "--service", "frontend"]

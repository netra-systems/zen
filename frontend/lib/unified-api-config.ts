    ...
    case 'production':
      return {
        ...
        endpoints: {
          ...
          // Auth service endpoints
          authConfig: 'https://auth.netrasystems.ai/api/auth/config',
          authLogin: 'https://auth.netrasystems.ai/api/auth/login',
          authLogout: 'https://auth.netrasystems.ai/api/auth/logout',
          authCallback: 'https://auth.netrasystems.ai/api/auth/callback',
          authToken: 'https://auth.netrasystems.ai/api/auth/token',
          authRefresh: 'https://auth.netrasystems.ai/api/auth/refresh',
          authValidate: 'https://auth.netrasystems.ai/api/auth/validate',
          authSession: 'https://auth.netrasystems.ai/api/auth/session',
          authMe: 'https://auth.netrasystems.ai/api/auth/me',
        },
        features: {
          useHttps: true,
    ...
    case 'staging':
      return {
        ...
        endpoints: {
          ...
          // Auth service endpoints
          authConfig: 'https://auth.staging.netrasystems.ai/api/auth/config',
          authLogin: 'https://auth.staging.netrasystems.ai/api/auth/login',
          authLogout: 'https://auth.staging.netrasystems.ai/api/auth/logout',
          authCallback: 'https://auth.staging.netrasystems.ai/api/auth/callback',
          authToken: 'https://auth.staging.netrasystems.ai/api/auth/token',
          authRefresh: 'https://auth.staging.netrasystems.ai/api/auth/refresh',
          authValidate: 'https://auth.staging.netrasystems.ai/api/auth/validate',
          authSession: 'https://auth.staging.netrasystems.ai/api/auth/session',
          authMe: 'https://auth.staging.netrasystems.ai/api/auth/me',
        },
        features: {
          useHttps: true,
          useWebSocketSecure: true,
    ...
    case 'test':
      return {
        ...
        endpoints: {
          ...
          authConfig: `${process.env.NEXT_PUBLIC_AUTH_URL || 'http://localhost:8081'}/api/auth/config`,
          authLogin: `${process.env.NEXT_PUBLIC_AUTH_URL || 'http://localhost:8081'}/api/auth/login`,
          authLogout: `${process.env.NEXT_PUBLIC_AUTH_URL || 'http://localhost:8081'}/api/auth/logout`,
          authCallback: `${process.env.NEXT_PUBLIC_AUTH_URL || 'http://localhost:8081'}/api/auth/callback`,
          authToken: `${process.env.NEXT_PUBLIC_AUTH_URL || 'http://localhost:8081'}/api/auth/token`,
          authRefresh: `${process.env.NEXT_PUBLIC_AUTH_URL || 'http://localhost:8081'}/api/auth/refresh`,
          authValidate: `${process.env.NEXT_PUBLIC_AUTH_URL || 'http://localhost:8081'}/api/auth/validate`,
          authSession: `${process.env.NEXT_PUBLIC_AUTH_URL || 'http://localhost:8081'}/api/auth/session`,
          authMe: `${process.env.NEXT_PUBLIC_AUTH_URL || 'http://localhost:8081'}/api/auth/me`,
        },
        features: {
          useHttps: false,

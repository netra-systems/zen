...
describe('Form Groups - Validation and Interactive Features', () => {
  ...
  it('supports accessible error summaries', async () => {
    const user = setupKeyboardTest();
    const ErrorSummaryForm = () => {
      ...
      const handleSubmit = (e: React.FormEvent) => {
        ...
        if (!formData.get('required-name')) {
          newErrors.push('Name is required');
        }
        if (!formData.get('required-email')) {
        ...
        <form onSubmit={handleSubmit}>
          ...
          <fieldset>
            ...
            <div>
              ...
              <Input id="summary-name" name="required-name" type="text" />
            </div>
            <div>
              <Label htmlFor="summary-email">Email</Label>
              <Input id="summary-email" name="required-email" type="email" />
            </div>
          </fieldset>
    ...
    const { container } = render(<ErrorSummaryForm />);

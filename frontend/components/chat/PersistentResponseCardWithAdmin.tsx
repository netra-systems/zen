...
interface ExtendedPersistentResponseCardProps extends PersistentResponseCardProps {
  isAdminAction?: boolean;
  adminType?: 'corpus' | 'synthetic' | 'users' | 'config' | 'logs';
  adminStatus?: 'pending' | 'in_progress' | 'completed' | 'failed';
  adminMetadata?: {
...
export const PersistentResponseCardWithAdmin: React.FC<ExtendedPersistentResponseCardProps> = ({
  fastLayerData,
  mediumLayerData,
  slowLayerData,
  isProcessing,

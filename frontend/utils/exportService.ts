...
export class ExportService {
   ...
   */
  private static createCSVFlatData(data: ReportData): Array<Record<string, string | number>> {
    const flatData: Array<Record<string, string | number>> = [];
    this.addMetricsToFlatData(flatData, data.metrics);
    this.addRecommendationsToFlatData(flatData, data.recommendations);
    this.addSectionsToFlatData(flatData, data.sections);
    return flatData;
  }
   ...
   */
  private static addMetricsToFlatData(flatData: Array<Record<string, string | number>>, metrics?: ExportMetrics): void {
    if (!metrics) return;
   ...
   */
  private static addRecommendationsToFlatData(flatData: Array<Record<string, string | number>>, recommendations?: ExportRecommendation[]): void {
   ...
   */
  private static addSectionsToFlatData(flatData: Array<Record<string, string | number>>, sections?: ExportSection[]): void {
    if (!sections) return;
    sections.forEach(section => {
      this.processSectionForCSV(flatData, section);
    });
  }
   ...
   */
  private static processSectionForCSV(flatData: Array<Record<string, string | number>>, section: ExportSection): void {
    if (Array.isArray(section.content)) {
      this.addArrayContentToFlatData(flatData, section);
    } else {
      this.addSingleContentToFlatData(flatData, section);
    }
  }
   ...
   */
  private static addArrayContentToFlatData(flatData: Array<Record<string, string | number>>, section: ExportSection): void {
   ...
   */
  private static addSingleContentToFlatData(flatData: Array<Record<string, string | number>>, section: ExportSection): void {
    flatData.push({
      Category: 'Section',
      Key: section.title,
  ...
  private static exportCSV(data: ReportData, filename: string): void {
    const flatData = this.createCSVFlatData(data);

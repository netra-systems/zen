...
**Generated:** 2025-08-15T11:18:59.963104  
...
|-----------|-------|--------|--------|---------|--------|----------|--------|
| Backend   | 7 | 7 | 0 | 0 | 0 | 6.22s | [PASSED] |
...
================================================================================
[PASS] ALL TESTS PASSED in 5.46s
================================================================================

2025-08-15 11:18:58.887 | INFO     | app.core.unified_logging:_emit_log:117 | Loaded 10 secrets from environment variables
2025-08-15 11:18:58.887 | DEBUG    | app.core.unified_logging:_emit_log:117 | Critical secrets present in env: gemini-api-key, jwt-secret-key, fernet-key
2025-08-15 11:18:58.887 | INFO     | app.core.unified_logging:_emit_log:117 | Using only environment variables for secrets (local development mode): 10 secrets loaded
2025-08-15 11:18:58.887 | INFO     | app.core.unified_logging:_emit_log:117 | Applying 10 secrets
2025-08-15 11:18:58.887 | INFO     | app.core.unified_logging:_emit_log:117 | Applied 10 secrets (from 10 loaded)
2025-08-15 11:18:58.887 | INFO     | app.core.unified_logging:_emit_log:117 | Critical secrets loaded: 3 (gemini-api-key, jwt-secret-key, fernet-key)
2025-08-15 11:18:58.887 | INFO     | app.core.unified_logging:_emit_log:117 | Configuration validation completed successfully
--- Logging error in Loguru Handler #1 ---
Record was: {'elapsed': datetime.timedelta(seconds=3, microseconds=793918), 'exception': None, 'extra': {}, 'file': (name='__init__.py', path='C:\\Users\\antho\\miniconda3\\Lib\\logging\\__init__.py'), 'function': 'handle', 'level': (name='INFO', no=20, icon='\u2139\ufe0f'), 'line': 1028, 'message': 'Multiprocessing resources cleaned up', 'module': '__init__', 'name': 'logging', 'process': (id=41244, name='MainProcess'), 'thread': (id=37276, name='MainThread'), 'time': datetime(2025, 8, 15, 11, 18, 59, 383500, tzinfo=datetime.timezone(datetime.timedelta(days=-1, seconds=61200), 'Pacific Daylight Time'))}

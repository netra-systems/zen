...
**Generated:** 2025-08-15T13:11:59.028455  
...
|-----------|-------|--------|--------|---------|--------|----------|--------|
| Backend   | 702 | 679 | 1 | 21 | 1 | 54.19s | [FAILED] |
...
[gw2][36m [  1%] [0m[32mPASSED[0m app\tests\services\test_agent_service_orchestration_agents.py::TestAgentLifecycleManagement::test_agen...(truncated)
```
...
### Backend Errors
- [gw0][36m [  8%] [0m[31mFAILED[0m app\tests\services\apex_optimizer_agent\tools\test_policy_simulator.py::TestPolicySimulator::test_policy_simulator_async_behavior
- [gw2][36m [ 29%] [0m[31mERROR[0m app\tests\services\test_quality_gate_validation.py::TestErrorHandling::test_database_connection_failure <- tests\helpers\shared_test_types.py
- =================================== ERRORS ====================================
...
- [FAIL] TESTS FAILED with exit code 2 after 53.17s

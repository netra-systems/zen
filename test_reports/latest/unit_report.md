...
**Generated:** 2025-08-15T14:42:11.900813  
...
|-----------|-------|--------|--------|---------|--------|----------|--------|
| Backend   | 1068 | 1041 | 3 | 23 | 1 | 56.21s | [FAILED] |
...
- [gw3][36m [ 41%] [0m[31mFAILED[0m app\tests\services\test_quality_gate_validation.py::TestErrorHandling::test_validate_content_calculation_error
- [gw0][36m [ 42%] [0m[31mFAILED[0m app\tests\services\test_state_persistence.py::TestStatePersistence::test_save_agent_state
- [gw2][36m [ 46%] [0m[31mFAILED[0m app\tests\services\test_schema_validation_service.py::TestSchemaValidationService::test_agent_message_schema Loaded .env file from C:\Users\antho\OneDrive\Desktop\Netra\netra-core-generation-1\.env
- =================================== ERRORS ====================================
- [31m[1m_ ERROR at setup of TestSupplyItemRetrieval.test_get_supply_items_with_confidence_filter _[0m
- [31mFAILED[0m app\tests\services\test_quality_gate_validation.py::[1mTestErrorHandling::test_validate_content_calculation_error[0m - AttributeError: <app.services.quality_gate.quality_gate_core.QualityGateService object at 0x0000020941C96FF0> does not have the attribute '_calculate_metrics'
...
- [FAIL] TESTS FAILED with exit code 2 after 54.95s

...
**Generated:** 2025-08-15T23:16:16.164696  
...
|-----------|-------|--------|--------|---------|--------|----------|--------|
| Backend   | 36 | 31 | 4 | 1 | 0 | 15.89s | [FAILED] |
...
[gw1][36m [  8%] [0m[32mPASSED[0m app/tests/agents/test_data_sub_agent.py::TestDataProcessing::test_process_data_success 
[gw3][36m [ 10%] [0m[32mPASSED[0m app/tests/agents/test_data_sub_agent.py::TestDataTransformation::test_transform_text_data 
...
[gw1][36m [ 16%] [0m[32mPASSED[0m app/tests/agents/test_data_sub_agent.py::TestDataProcessing::test_process_data_validation_failure 
[gw3][36m [ 17%] [0m[32mPASSED[0m app/tests/agents/test_data_sub_agent.py::TestDataTransformation::test_transform_json_data 
[gw0][36m [ 19%] [0m[32mPASSED[0m app/tests/agents/test_data_sub_agent.py::TestDataEnrichment::test_enrich_with_metadata 
...
[gw3][36m [ 21%] [0m[32mPASSED[0m app/tests/agents/test_data_sub_agent.py::TestDataTransformation::test_transform_with_pipeline 
[gw1][36m [ 23%] [0m[32mPASSED[0m app/tests/agents/test_data_sub_agent.py::TestDataProcessing::test_batch_processing 
[gw0][36m [ 25%] [0m[32mPASSED[0m app/tests/agents/test_data_sub_agent.py::TestDataEnrichment::test_enrich_with_external_source 
...
[gw0][36m [ 26%] [0m[32mPASSED[0m app/tests/agents/test_data_sub_agent.py::TestErrorHandling::test_redis_connection_failure_recovery <- app\tests\helpers\shared_test_types.py 
[gw1][36m [ 28%] [0m[32mPASSED[0m app/tests/agents/test_data_sub_agent.py::TestIntegration::test_async_operations <- app\tests\helpers\shared_test_types.py 
...
[gw0][36m [ 30%] [0m[32mPASSED[0m app/tests/agents/test_data_sub_agent.py::TestErrorHandling::test_database_connection_failure 
app/tests/agents/test_data_sub_agent.py::TestIntegration::test_integration_with_supervisor 
[gw1][36m [ 32%] [0m[32mPASSED[0m app/tests/agents/test_data_sub_agent.py::TestIntegration::test_integration_with_websocket 
[gw0][36m [ 33%] [0m[32mPASSED[0m app/tests/agents/test_data_sub_agent.py::TestIntegration::test_integration_with_supervisor 
...
[gw0][36m [ 37%] [0m[33mSKIPPED[0m app/tests/agents/test_data_sub_agent.py::TestStateManagement::test_state_recovery 
tests/test_actions_sub_agent.py::TestActionsSubAgentInitialization::test_agent_initialization_success 
[gw0][36m [ 39%] [0m[32mPASSED[0m tests/test_actions_sub_agent.py::TestActionsSubAgentInitialization::test_agent_initialization_success 
...
[gw2][36m [ 51%] [0m[32mPASSED[0m app/tests/agents/test_data_sub_agent.py::TestErrorHandling::test_retry_on_failure 
app/tests/agents/test_data_sub_agent.py::TestErrorHandling::test_max_retries_exceeded 
[gw2][36m [ 53%] [0m[32mPASSED[0m app/tests/agents/test_data_sub_agent.py::TestErrorHandling::test_max_retries_exceeded 
app/tests/agents/test_data_sub_agent.py::TestErrorHandling::test_graceful_degradation 
[gw2][36m [ 55%] [0m[32mPASSED[0m app/tests/agents/test_data_sub_agent.py::TestErrorHandling::test_graceful_degradation 
app/tests/agents/test_data_sub_agent.py::TestCaching::test_cache_hit 
[gw2][36m [ 57%] [0m[32mPASSED[0m app/tests/agents/test_data_sub_agent.py::TestCaching::test_cache_hit 
...
[gw0][36m [ 62%] [0m[31mFAILED[0m tests/test_actions_sub_agent.py::TestSuccessfulExecution::test_execute_success_with_valid_json 
[gw2][36m [ 64%] [0m[31mFAILED[0m tests/test_actions_sub_agent.py::TestJSONExtractionAndFallbacks::test_json_extraction_failure_with_partial_recovery Loaded .env file ...(truncated)
```
...
- [gw1][36m [ 60%] [0m[31mFAILED[0m app/tests/agents/test_data_sub_agent.py::TestIntegration::test_integration_with_database
- [gw0][36m [ 62%] [0m[31mFAILED[0m tests/test_actions_sub_agent.py::TestSuccessfulExecution::test_execute_success_with_valid_json
- [gw2][36m [ 64%] [0m[31mFAILED[0m tests/test_actions_sub_agent.py::TestJSONExtractionAndFallbacks::test_json_extraction_failure_with_partial_recovery Loaded .env file from C:\Users\antho\OneDrive\Desktop\Netra\netra-core-generation-1\.env
...
- [FAIL] TESTS FAILED with exit code 2 after 14.82s

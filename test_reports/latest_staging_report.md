...
**Generated:** 2025-08-21T10:44:20.156738  
...
|-----------|-------|--------|--------|---------|--------|----------|--------|
| Backend   | 0 | 0 | 0 | 0 | 0 | 14.43s | [FAILED] |
...
================================================================================
================================================================================
[FAIL] TESTS FAILED with exit code 4 after 12.23s
================================================================================
...
netra_backend\app\agents\base_agent.py:17: in <module>
    from netra_backend.app.agents.agent_lifecycle import AgentLifecycleMixin
netra_backend\app\agents\agent_lifecycle.py:11: in <module>
    from netra_backend.app.routes.unified_tools.schemas import SubAgentLifecycle
E   ImportError: cannot import name 'SubAgentLifecycle' from 'netra_backend.app.routes.unified_tools.schemas' (C:\Users\antho\OneDrive\Desktop\Netra\netra-core-generation-1\netra_backend\app\routes\unified_tools\schemas.py)

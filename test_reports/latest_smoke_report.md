...
**Generated:** 2025-08-21T15:46:09.161116  
...
|-----------|-------|--------|--------|---------|--------|----------|--------|
| Backend   | 2 | 0 | 0 | 0 | 2 | 7.66s | [FAILED] |
...
=================================== ERRORS ====================================
[31m[1m_____________ ERROR collecting tests/core/test_config_manager.py ______________[0m
...
..\..\..\..\miniconda3\Lib\importlib\__init__.py:90: in import_module
    return _bootstrap._gcd_import(name[level:], package, level)
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
netra_backend\tests\core\test_config_manager.py:26: in <module>
    from netra_backend.app.core.configuration.base import ConfigManager
E   ImportError: cannot import name 'ConfigManager' from 'netra_backend.app.core.configuration.base' (C:\Users\antho\OneDrive\Desktop\Netra\netra-core-generation-1\netra_backend\app\core\configuration\base.py)[0m
...
[31mERROR[0m netra_backend\tests\core\test_config_manager.py
[31mERROR[0m netra_backend - _pytest.main.Failed: stopping after 1 failures
[31m!!!!!!!!!!!!!!!!!!!!!!!!!! stopping after 2 failures !!!!!!!!!!!!!!!!!!!!!!!!!![0m
[31m============================== [31m[1m2 errors[0m[31m in 0.66s[0m[31m ==============================[0m
================================================================================
[FAIL] TESTS FAILED with exit code 4 after 6.52s
================================================================================

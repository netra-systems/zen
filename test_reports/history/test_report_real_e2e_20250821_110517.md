...
**Generated:** 2025-08-21T11:04:20.484392  
...
|-----------|-------|--------|--------|---------|--------|----------|--------|
| Backend   | 0 | 0 | 0 | 0 | 0 | 3.27s | [FAILED] |
...
================================================================================
================================================================================
[FAIL] TESTS FAILED with exit code 4 after 2.74s
================================================================================
...
netra_backend\app\auth_integration\__init__.py:97: in <module>
    from netra_backend.app.agents.interfaces import (
E   ImportError: cannot import name 'AuthClientProtocol' from 'netra_backend.app.agents.interfaces' (C:\Users\antho\OneDrive\Desktop\Netra\netra-core-generation-1\netra_backend\app\agents\interfaces.py)

...
**Generated:** 2025-08-21T11:53:10.127625  
...
|-----------|-------|--------|--------|---------|--------|----------|--------|
| Backend   | 0 | 0 | 0 | 0 | 0 | 7.36s | [FAILED] |
| Frontend  | 69 | 11 | 58 | 0 | 0 | 55.68s | [FAILED] |
...
================================================================================
================================================================================
[FAIL] TESTS FAILED with exit code 4 after 6.35s
================================================================================
...
C:\Users\antho\miniconda3\Lib\site-packages\pydantic\_internal\_fields.py:198: UserWarning: Field name "schema" in "DataCatalog" shadows an attribute in parent "BaseModel"
  warnings.warn(
2025-08-21 11:52:11.826 | ERROR    | logging:handle:1028 | Error loading blocked IPs config: [Errno 2] No such file or directory: 'C:\\Users\\antho\\OneDrive\\Desktop\\Netra\\netra-core-generation-1\\netra_backend\\config\\blocked_ips.json'
...
FAIL __tests__/integration/websocket-complete-refactored.test.tsx (53.28 s)
  ...
  ● WebSocket Connection Lifecycle Tests › Reconnection Scenarios › should test real WebSocket reconnection strategies
    ...
    [31m[1m>[22m[39m[90m 169 |[39m           reject([36mnew[39m [33mError[39m([32m'Connection timeout'[39m))[33m;[39m
     ...
     [90m 172 |[39m           queueMicrotask(checkConnection)[33m;[39m[0m
      ...
      at checkConnection (__te...(truncated)
```

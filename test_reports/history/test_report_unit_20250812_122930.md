...
**Generated:** 2025-08-12T12:29:30.694004  
...
|-----------|-------|--------|--------|---------|--------|----------|--------|
| Backend   | 169 | 166 | 3 | 0 | 0 | 38.82s | [FAILED] |
| Frontend  | 295 | 18 | 277 | 0 | 0 | 32.44s | [FAILED] |
...
[gw2][36m [  2%] [0m[31mFAILED[0m app\tests\services\test_database_repositories.py::TestBaseRepository::test_repository_update 
...
[gw1][36m [  2%] [0m[32mPASSED[0m app\tests\services\test_agent_service_orchestration.py::TestAgentErrorRecovery::test_agent_failure...(truncated)
```
...
FAIL __tests__/setup/websocket-mock.ts
  ● Test suite failed to run
      ...
      [31mx[0m Expression expected
         ,-[[36;1;4mC:\Users\antho\OneDrive\Desktop\Netra\netra-core-generation-1\frontend\__tests__\setup\websocket-mock.ts[0m:129:1]
     [2m126[0m | 
     [2m127[0m | // Mock WebSocket provider for React components
     [2m128[0m | export const MockWebSocketProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
     [2m129[0m |   return <>{children}</>;
         : [35;1m          ^[0m
     [2m130[0m | };
         `----
...
FAIL __tests__/hooks/useWebSocketLifecycle.test.tsx
  ...
  ● useWebSocket Hook Lifecycle › Hook Initialization and Cleanup › should setup event listeners on mount
    ...
    [31m[1m>[22m[39m[90m 30 |[39m   [36mconst[39m { token } [33m=[39m useContext([33mAuthContext[39m)[33m![39m[33m;[39m
     [90m    |[39m           [31m[1m^[22m[39m
     [90m 31 |[39m   [36mconst[39m [status[33m,[39m setStatus] [33m=[39m useState[33m<[39m[33mWebSocketStatus[39m[33m>[39m([32m'CLOSED'[39m)[33m;[39m
     [90m 32 |[39m   [36mconst[39m [messages[33m,[39m setMessages] [33m=[39m useState[33m<[39m[33mWebSocketMessage[39m[]...(truncated)
```
...
- [gw3][36m [ 11%] [0m[31mFAILED[0m app\tests\services\test_quality_gate_service.py::TestQualityGateService::test_validate_action_plan_completeness
- 2025-08-12 12:28:39.303 | ERROR    | app.services.database.unit_of_work:__aexit__:52 | UnitOfWork rolled back due to exception: unit_of_work.<locals>.<lambda>() takes 0 positional arguments but 1 was given
- [31mFAILED[0m app\tests\services\test_database_repositories.py::[1mTestBaseRepository::test_repository_update[0m - TypeError: unit_of_work.<locals>.<lambda>() takes 0 positional arguments but 1 was given
...
- [FAIL] TESTS FAILED with exit code 2 after 38.04s
...
- FAIL __tests__/components/ChatHistorySection.test.tsx (7.536 s)
- FAIL __tests__/chat/chatUIUXCore.test.tsx
- FAIL __tests__/system/startup.test.tsx (11.879 s)
- FAIL __tests__/components/chat/MainChat.test.tsx (12.252 s)
- FAIL __tests__/chat/ui-improvements.test.tsx
- FAIL __tests__/components/chat/MessageInput.test.tsx (21.433 s)
- FAIL __tests__/integration/comprehensive-integration.test.tsx (25.488 s)
- FAIL __tests__/components/ChatComponents.test.tsx (25.859 s)
- FAIL __tests__/setup/websocket-mock.ts
- FAIL __tests__/hooks/additionalHooks.test.tsx
- FAIL __tests__/hooks/useWebSocketLifecycle.test.tsx
- FAIL __tests__/hooks/useAgent.test.tsx

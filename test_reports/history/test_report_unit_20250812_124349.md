...
**Generated:** 2025-08-12T12:43:49.401445  
...
|-----------|-------|--------|--------|---------|--------|----------|--------|
| Backend   | 174 | 171 | 3 | 0 | 0 | 39.26s | [FAILED] |
| Frontend  | 295 | 18 | 277 | 0 | 0 | 31.64s | [FAILED] |
...
[gw0][36m [  2%] [0m[32mPASSED[0m app\tests\services\a...(truncated)
```
...
- [gw3][36m [ 12%] [0m[31mFAILED[0m app\tests\services\test_quality_gate_service.py::TestQualityGateService::test_validate_with_strict_mode
- 2025-08-12 12:42:58.859 | ERROR    | app.services.database.unit_of_work:__aexit__:52 | UnitOfWork rolled back due to exception: assert <AsyncMock id='2019232745616'> is None
- [31mFAILED[0m app\tests\services\test_database_repositories.py::[1mTestBaseRepository::test_repository_delete[0m - AssertionError: assert <AsyncMock id='2019232745616'> is None
...
- [FAIL] TESTS FAILED with exit code 2 after 38.44s
...
- FAIL __tests__/components/ChatHistorySection.test.tsx (7.38 s)
- FAIL __tests__/chat/chatUIUXCore.test.tsx
- FAIL __tests__/system/startup.test.tsx (11.792 s)
- FAIL __tests__/components/chat/MainChat.test.tsx (12.091 s)
- FAIL __tests__/chat/ui-improvements.test.tsx
- FAIL __tests__/components/chat/MessageInput.test.tsx (17.227 s)
- FAIL __tests__/components/ChatComponents.test.tsx (21.35 s)
- FAIL __tests__/integration/comprehensive-integration.test.tsx (25.369 s)
- FAIL __tests__/hooks/additionalHooks.test.tsx
- FAIL __tests__/hooks/useAgent.test.tsx
- FAIL __tests__/hooks/useWebSocketLifecycle.test.tsx
- FAIL __tests__/components/AgentStatusPanel.test.tsx

...
**Generated:** 2025-08-21T10:35:20.917986  
**Test Level:** staging - Staging environment configuration integration tests (10-15 minutes)  
...
```
netra_backend/tests/integration/staging_config -v --fail-fast --parallel=2
```
...
Running command:
  pytest -c C:\Users\antho\OneDrive\Desktop\Netra\netra-core-generation-1\pytest.ini netra_backend/tests/integration/staging_config -vv -n 2 -x --maxfail=1 --tb=short --asyncio-mode=auto --color=yes --strict-markers --disable-warnings -p no:warnings
================================================================================
================================================================================
[FAIL] TESTS FAILED with exit code 4 after 4.18s
================================================================================
...
netra_backend\app\routes\unified_tools\router.py:9: in <module>
    from netra_backend.app.services.unified_tool_registry import UnifiedToolRegistry
netra_backend\app\services\unified_tool_registry\__init__.py:9: in <module>
    from netra_backend.app.services.unified_tool_registry.registry import UnifiedToolRegistry
netra_backend\app\services\unified_tool_registry\registry.py:9: in <module>
    from netra_backend.app.services.apex_optimizer_agent.models import UnifiedTool, ToolExecutionResult
E   ImportError: cannot import name 'UnifiedTool' from 'netra_backend.app.services.apex_optimizer_agent.models' (C:\Users\antho\OneDrive\Desktop\Netra\netra-core-generation-1\netra_backend\app\services\apex_optimizer_agent\models.py)

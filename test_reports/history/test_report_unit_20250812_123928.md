...
**Generated:** 2025-08-12T12:39:28.907129  
...
|-----------|-------|--------|--------|---------|--------|----------|--------|
| Backend   | 174 | 171 | 3 | 0 | 0 | 52.52s | [FAILED] |
| Frontend  | 295 | 18 | 277 | 0 | 0 | 31.20s | [FAILED] |
...
[gw3][36m [  1%] [0m[32mPASSED[0m app\tests\services\test_database_repositories.py::TestBaseRepository::test_repository_update 
...
[gw3][36m [  2%] [0m[32mPASSED[0m app\tests\services\test_database_repositories.py::TestBaseRepository::test_repository_delete 
...
app\tests\services\apex_optimizer_agent\tools\test_base.py::TestBaseT...(truncated)
```
...
### Backend Errors
- [gw3][36m [  2%] [0m[31mFAILED[0m app\tests\services\test_database_repositories.py::TestBaseRepository::test_repository_soft_delete
- [gw1][36m [  3%] [0m[31mFAILED[0m app\tests\services\test_apex_optimizer_tool_selection.py::TestApexOptimizerToolSelection::test_tool_selection_model_analysis
...
- 2025-08-12 12:38:38.602 | ERROR    | app.services.database.unit_of_work:__aexit__:52 | UnitOfWork rolled back due to exception: assert None is not None
- [31mFAILED[0m app\tests\services\test_database_repositories.py::[1mTestBaseRepository::test_repository_soft_delete[0m - assert None is not None
- [31mFAILED[0m app\tests\services\test_apex_optimizer_tool_selection.py::[1mTestApexOptimizerToolSelection::test_tool_selection_model_analysis[0m - pydantic_core._pydantic_core.ValidationError: 2 validation errors for RequestModel
...
- [FAIL] TESTS FAILED with exit code 2 after 51.63s
...
- FAIL __tests__/components/ChatHistorySection.test.tsx (7.632 s)
- FAIL __tests__/chat/chatUIUXCore.test.tsx
- FAIL __tests__/system/startup.test.tsx (11.926 s)
- FAIL __tests__/components/chat/MainChat.test.tsx (12.377 s)
- FAIL __tests__/chat/ui-improvements.test.tsx
- FAIL __tests__/components/chat/MessageInput.test.tsx (17.332 s)
- FAIL __tests__/components/ChatComponents.test.tsx (21.761 s)

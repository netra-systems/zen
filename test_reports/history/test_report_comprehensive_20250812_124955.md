...
**Generated:** 2025-08-12T12:49:55.052436  
...
|-----------|-------|--------|--------|---------|--------|----------|--------|
| Backend   | 2 | 0 | 0 | 1 | 1 | 31.71s | [FAILED] |
| Frontend  | 295 | 18 | 277 | 0 | 0 | 80.70s | [FAILED] |
...
[31m======================== [33m1 skipped[0m, [31m[1m1 error[0m[31m in 21.75s[0m[31m =========================[0m
================================================================================
[FAIL] TESTS FAILED with exit code 2 after 30.62s
...
---------------------------------|---------|----------|---------|---------|--------------------------------------------------------------------------------------------------------------
All files                        |   65.13 |    79.11 |   50.17 |   65.13 |                                                                                                              
...
- FAIL __tests__/integration/advanced-integration.test.tsx (5.042 s)
- FAIL __tests__/auth/context.test.tsx (5.15 s)
- FAIL __tests__/imports/external-imports.test.tsx (5.351 s)
- FAIL __tests__/imports/internal-imports.test.tsx (6.395 s)
- FAIL __tests__/system/startup.test.tsx (12.459 s)
- FAIL __tests__/chat/chatUIUXCore.test.tsx
- FAIL __tests__/components/chat/MainChat.test.tsx (13.66 s)
- FAIL __tests__/components/ChatHistorySection.test.tsx (14.945 s)
- FAIL __tests__/chat/ui-improvements.test.tsx
- FAIL __tests__/integration/comprehensive-integration.test.tsx (26.71 s)
- FAIL __tests__/components/chat/MessageInput.test.tsx (28.843 s)
- FAIL __tests__/components/ChatComponents.test.tsx (69.436 s)
- FAIL __tests__/hooks/useWebSocketLifecycle.test.tsx
- FAIL __tests__/hooks/additionalHooks.test.tsx
- FAIL __tests__/components/AgentStatusPanel.test.tsx
- FAIL __tests__/components/ChatHistory.test.tsx

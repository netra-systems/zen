...
# SSOT REMEDIATION: ExecutionEngineFactory removed to enforce single canonical factory
# Any imports should use: netra_backend.app.agents.supervisor.execution_engine_factory.ExecutionEngineFactory

def ExecutionEngineFactory(*args, **kwargs):
    """REMOVED: Redirect to canonical SSOT ExecutionEngineFactory.
    
    This factory was over-engineered and violated SSOT principles.
    """
    raise ImportError(
        "ExecutionEngineFactory has been consolidated to SSOT. "
        "Import from: netra_backend.app.agents.supervisor.execution_engine_factory.ExecutionEngineFactory"
    )

# Export for compatibility (error-raising stubs)
__all__ = ['DeprecatedFactoryPlaceholder']

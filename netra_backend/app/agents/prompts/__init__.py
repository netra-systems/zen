...
from netra_backend.app.agents.prompts.optimization_prompts import optimizations_core_prompt_template
from netra_backend.app.agents.prompts.action_prompts import actions_to_meet_goals_prompt_template

...
# FIXME: # FIXME: DataSubAgentClickHouseOperations not available
# FIXME: # from netra_backend.app.services.corpus.clickhouse_operations import ClickHouseOperations as DataSubAgentClickHouseOperations
...
class DataSubAgentCore:
    ...
    def _init_core_components(self) -> None:
        ...
        # FIXME: self.clickhouse_ops = DataSubAgentClickHouseOperations()

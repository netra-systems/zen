...
class ErrorCode(Enum):
    ...
    # Tool errors (8000-8999)
    TOOL_TYPE_VALIDATION_ERROR = "TOOL_TYPE_VALIDATION_ERROR"
    TOOL_NAME_VALIDATION_ERROR = "TOOL_NAME_VALIDATION_ERROR"
    TOOL_HANDLER_VALIDATION_ERROR = "TOOL_HANDLER_VALIDATION_ERROR"
    TOOL_NOT_FOUND = "TOOL_NOT_FOUND"
    TOOL_EXECUTION_FAILED = "TOOL_EXECUTION_FAILED"
    TOOL_ACCESS_DENIED = "TOOL_ACCESS_DENIED"
    TOOL_DEPENDENCY_MISSING = "TOOL_DEPENDENCY_MISSING"
    TOOL_CATEGORY_INVALID = "TOOL_CATEGORY_INVALID"
...
class ErrorCodeMap:
    ...
    _ERROR_SEVERITY_MAP = {
        ...
        # Tool errors
        ErrorCode.TOOL_TYPE_VALIDATION_ERROR: ErrorSeverity.MEDIUM,
        ErrorCode.TOOL_NAME_VALIDATION_ERROR: ErrorSeverity.MEDIUM,
        ErrorCode.TOOL_HANDLER_VALIDATION_ERROR: ErrorSeverity.MEDIUM,
        ErrorCode.TOOL_NOT_FOUND: ErrorSeverity.LOW,
        ErrorCode.TOOL_EXECUTION_FAILED: ErrorSeverity.HIGH,
        ErrorCode.TOOL_ACCESS_DENIED: ErrorSeverity.HIGH,
        ErrorCode.TOOL_DEPENDENCY_MISSING: ErrorSeverity.MEDIUM,
        ErrorCode.TOOL_CATEGORY_INVALID: ErrorSeverity.MEDIUM,
    }

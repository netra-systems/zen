...
def _import_core_routers() -> dict:
    ...
    return {"llm_cache_router": llm_cache_router, "threads_router": threads_router, "mcp_router": mcp_router, "messages_router": messages_router, "events_stream_router": events_stream_router}

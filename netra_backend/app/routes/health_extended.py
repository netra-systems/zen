...
from netra_backend.app.dependencies import get_request_scoped_db_session_for_fastapi
...
@router.get("/database")
async def health_database(db: AsyncSession = Depends(get_request_scoped_db_session_for_fastapi)) -> Dict[str, Any]:

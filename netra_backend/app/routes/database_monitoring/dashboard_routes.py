...
def handle_dashboard_error(e: Exception) -> None:
    """Handle dashboard retrieval error."""
...
def handle_current_metrics_error(e: Exception) -> None:
    """Handle current metrics retrieval error."""
...
async def get_current_metrics_handler() -> Dict[str, Any]:
    ...
    try:
        ...
        handle_current_metrics_error(e)


def handle_metrics_history_error(e: Exception) -> None:
    """Handle metrics history retrieval error."""
...
async def get_metrics_history_handler(hours: int) -> List[Dict[str, Any]]:
    ...
    try:
        ...
        handle_metrics_history_error(e)


def handle_connection_status_error(e: Exception) -> None:
    """Handle connection status retrieval error."""
...
async def get_connection_status_handler() -> Dict[str, Any]:
    ...
    try:
        ...
        handle_connection_status_error(e)
...
class TestCorpusAdminSubAgentSSOTCompliance:
    ...
    def real_llm_manager():
        ...
        manager = MagicMock()  # TODO: Use real service instance
        # Only add WebSocket-specific methods
        manager.emit_agent_started = AsyncMock()  # TODO: Use real service instance
        manager.emit_thinking = AsyncMock()  # TODO: Use real service instance
        manager.emit_tool_executing = AsyncMock()  # TODO: Use real service instance
        manager.emit_tool_completed = AsyncMock()  # TODO: Use real service instance
        manager.emit_agent_completed = AsyncMock()  # TODO: Use real service instance
        manager.emit_error = AsyncMock()  # TODO: Use real service instance
        ...
        mock_bridge.emit_agent_started = AsyncMock()  # TODO: Use real service instance
        mock_bridge.emit_thinking = AsyncMock()  # TODO: Use real service instance
        mock_bridge.emit_tool_executing = AsyncMock()  # TODO: Use real service instance
        mock_bridge.emit_tool_completed = AsyncMock()  # TODO: Use real service instance
        mock_bridge.emit_agent_completed = AsyncMock()  # TODO: Use real service instance
        mock_bridge.emit_error = AsyncMock()  # TODO: Use real service instance
        ...
        mock_manager.commit = AsyncMock()  # TODO: Use real service instance
        mock_manager.rollback = AsyncMock()  # TODO: Use real service instance
        mock_manager.close = AsyncMock()  # TODO: Use real service instance
        ...
        mock_transaction_context = AsyncMock()  # TODO: Use real service instance
        ...
        with patch('netra_backend.app.database.session_manager.DatabaseSessionManager') as mock_manager_class:
        mock_managers = [Mock()  # TODO: Use real service instance for _ in range(num_concurrent_operations)]

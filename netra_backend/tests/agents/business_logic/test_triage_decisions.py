...
class TestTriageDecisionLogic:
    ...
    async def triage_agent(self):
        ...
        llm_manager = AsyncMock()  # TODO: Use real service instance
        tool_dispatcher = AsyncMock()  # TODO: Use real service instance
        websocket_manager = AsyncMock()  # TODO: Use real service instance

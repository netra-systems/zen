...
class TestCorpusAdminIntegration:
    ...
    def real_llm_manager():
        ...
        tool_dispatcher.execute_tool = AsyncMock()  # TODO: Use real service instance
        ...
        websocket_manager.send_status_update = AsyncMock()  # TODO: Use real service instance
        ...
        "score": 0.95,
        "metadata": {"document_type": "guide", "created_at": "2025-8-29"}
        },
        {
        "id": "doc_2", 
        ...
        "score": 0.87,
        "metadata": {"document_type": "guide", "created_at": "2025-8-28"}
        }
        ]

...
class TestMultiAgentCoordinationPerformance:
    ...
    def agent_pool(self):
        ...
        supervisor.execute = AsyncMock()  # TODO: Use real service instance
        supervisor.get_status = Mock(return_value="idle")
        supervisor.delegate_task = AsyncMock()  # TODO: Use real service instance
        ...
        manager.coordinate_agents = AsyncMock()  # TODO: Use real service instance
        manager.schedule_tasks = AsyncMock()  # TODO: Use real service instance
        manager.monitor_progress = AsyncMock()  # TODO: Use real service instance
        manager.handle_agent_failure = AsyncMock()  # TODO: Use real service instance
        manager.balance_load = AsyncMock()  # TODO: Use real service instance
        return manager
        ...
        agent_instances = {
        "data": [Mock()  # TODO: Use real service instance for _ in range(3)],
        "analysis": [Mock()  # TODO: Use real service instance for _ in range(2)],
        "research": [Mock()  # TODO: Use real service instance for _ in range(4)]
        }

...
class BusinessValueCoreTests(BusinessValueFixtures):
    ...
    def _get_optimization_calls(self, llm_manager):
        ...
        return [call for call in llm_manager.ask_llm.call_args_list if 'optimiz' in str(call).lower()]
    ...
    def _get_cost_analysis_calls(self, tool_calls):
        ...
        return [call for call in tool_calls if 'cost' in str(call).lower()]
    ...
    def _get_bottleneck_calls(self, tool_dispatcher):
        ...
        return [call for call in tool_dispatcher.dispatch_tool.call_args_list if 'bottleneck' in str(call).lower()]
    ...
    def _get_batch_optimization_prompts(self, llm_manager):
        ...
        return [call for call in llm_manager.ask_llm.call_args_list if 'batch' in str(call).lower() or 'optimiz' in str(call).lower()]

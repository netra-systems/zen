...
class TestCriticalMessageRoutingToAgentService:
    ...
    def real_websocket(self):
        ...
        ws.app = Mock()  # Initialize appropriate service
        # Mock: Generic component isolation for controlled unit testing
        ws.app.state = Mock()  # Initialize appropriate service
        # Mock: Agent service isolation for testing without LLM agent execution
        ws.app.state.agent_service = AsyncMock(spec=AgentService)
        # Mock: Generic component isolation for controlled unit testing
        ws.app.state.agent_service.handle_websocket_message = AsyncMock()  # TODO: Use real service instance
        return ws
    
        @pytest.fixture
        def real_agent_service(self):
        """Create mock agent service."""
        from unittest.mock import AsyncMock
        # Mock: Agent service isolation for testing without LLM agent execution
        agent_service = AsyncMock(spec=AgentService)
        # Mock: Generic component isolation for controlled unit testing
        agent_service.handle_websocket_message = AsyncMock()  # TODO: Use real service instance
        ...
        # Mock: Generic component isolation for controlled unit testing
        mock_db.return_value.__aexit__ = AsyncMock()  # TODO: Use real service instance
        ...
        # Mock: Generic component isolation for controlled unit testing
        mock_message_handler = AsyncMock()  # TODO: Use real service instance
        # Mock: Generic component isolation for controlled unit testing
        mock_message_handler.handle_user_message = AsyncMock()  # TODO: Use real service instance

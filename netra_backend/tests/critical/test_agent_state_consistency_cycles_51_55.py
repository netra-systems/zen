...
class TestAgentStateConsistency:
    ...
    async def state_manager(self):
        ...
        manager.save_agent_state = AsyncMock()  # TODO: Use real service instance
        manager.get_agent_state = AsyncMock()  # TODO: Use real service instance
        manager.create_state_checkpoint = AsyncMock()  # TODO: Use real service instance
        manager._force_save_state = AsyncMock()  # TODO: Use real service instance
        manager.detect_state_corruption = AsyncMock()  # TODO: Use real service instance
        manager.recover_agent_state = AsyncMock()  # TODO: Use real service instance
        manager.get_recovery_history = AsyncMock()  # TODO: Use real service instance
        manager.resolve_state_conflicts = AsyncMock()  # TODO: Use real service instance
        manager.sync_state_to_node = AsyncMock()  # TODO: Use real service instance
        manager.initialize = AsyncMock()  # TODO: Use real service instance
        manager.cleanup = AsyncMock()  # TODO: Use real service instance
        ...
        mock_session_2 = AsyncMock()  # TODO: Use real service instance
        new_state_manager = AgentStateManager(mock_session_2)
        new_state_manager.get_agent_state = AsyncMock()  # TODO: Use real service instance
        new_state_manager.save_agent_state = AsyncMock()  # TODO: Use real service instance
        new_state_manager.initialize = AsyncMock()  # TODO: Use real service instance
        new_state_manager.cleanup = AsyncMock()  # TODO: Use real service instance

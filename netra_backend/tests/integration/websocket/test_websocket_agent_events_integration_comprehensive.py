...
class TestWebSocketAgentEventsIntegrationComprehensive(SSotAsyncTestCase):
    ...
    def setup_method(self, method=None):
        ...
        self.websocket_notifier = WebSocketNotifier.create_for_user(self.mock_websocket_manager, test_mode=True)
    ...
    async def test_event_delivery_error_recovery_integration(self):
        ...
        error_notifier = WebSocketNotifier.create_for_user(error_websocket_manager)

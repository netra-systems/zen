...
class TestWebSocketHeartbeatMonitoring(SSotAsyncTestCase):
    ...
    def setup_method(self, method):
        ...
        self.test_user = TestUserData(user_id=f'heartbeat_user_{uuid.uuid4().hex[:8]}', email='heartbeat-test@netra.ai', tier='enterprise', thread_id=f'heartbeat_thread_{uuid.uuid4().hex[:8]}')

...
class WebSocketAuthProtocolIntegrationTests(SSotAsyncTestCase):
    ...
    async def asyncSetUpClass(cls):
        ...
        cls.test_user_payload = {'sub': 'test_user_protocol_auth', 'email': 'test@netrasystems.ai', 'exp': 9999999999, 'iat': 1000000000}
        cls.valid_jwt_token = await generate_access_token(user_id='test_user_protocol_auth', email='test@netrasystems.ai')

"""Test module: test_staging_auth_service_integration_core.py
...
class TestStagingAuthServiceIntegrationCore:
    """Test class for staging_auth_service_integration_core"""

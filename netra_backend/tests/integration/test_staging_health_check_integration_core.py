"""Test module: test_staging_health_check_integration_core.py
...
class TestStagingHealthCheckIntegrationCore:
    """Test class for staging_health_check_integration_core"""

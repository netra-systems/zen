"""Test module: test_user_session_persistence_restart_core.py
...
class TestUserSessionPersistenceRestartCore:
    """Test class for user_session_persistence_restart_core"""

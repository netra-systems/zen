...
class TestReportFormatContentValidationIntegration(BaseIntegrationTest):
    ...
    async def test_report_accessibility_and_internationalization(self, real_services_fixture):
        ...
        international_versions = [
            {
                "language_code": "es-ES",
                "title": "Análisis de Optimización de Costos en la Nube",
                "executive_summary": "El análisis de costos identificó $45,000 en oportunidades de ahorro anual através de optimización de infraestructura e iniciativas de dimensionamiento adecuado.",
                "region": "Europe"
            },
            {
                "language_code": "fr-FR", 
                "title": "Analyse d'Optimisation des Coûts Cloud",
                "executive_summary": "L'analyse des coûts a identifié 45 000 $ d'opportunités d'économies annuelles grâce à l'optimisation de l'infrastructure et aux initiatives de dimensionnement approprié.",
                "region": "Europe"
            },
            {
                "language_code": "ja-JP",
                "title": "クラウドコスト最適化分析",
                "executive_summary": "コスト分析により、インフラストラクチャの最適化と適切なサイジングの取り組みを通じて、年間$45,000の節約機会が特定されました。",
                "region": "Asia"
            }
        ]

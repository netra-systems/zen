"""Test module: test_metrics_aggregation_pipeline_helpers.py
...
class TestMetricsAggregationPipelineHelpers:
    """Test class for metrics_aggregation_pipeline_helpers"""

"""Test module: test_staging_health_check_integration_helpers.py
...
class TestStagingHealthCheckIntegrationHelpers:
    """Test class for staging_health_check_integration_helpers"""

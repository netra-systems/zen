...
class TestExistingUserLoginFlow:
    ...
    async def mock_existing_user(self):
        ...
        service.authenticate = AsyncMock()  # TODO: Use real service instance
        # Mock: Generic component isolation for controlled unit testing
        service.generate_tokens = AsyncMock()  # TODO: Use real service instance
        # Mock: Async component isolation for testing without real async operations
        service.validate_token = AsyncMock(return_value=True)
        # Mock: Generic component isolation for controlled unit testing
        service.refresh_tokens = AsyncMock()  # TODO: Use real service instance
        # Mock: Generic component isolation for controlled unit testing
        service.revoke_token = AsyncMock()  # TODO: Use real service instance
        yield service
        ...
        service.create_session = AsyncMock()  # TODO: Use real service instance
        # Mock: Session isolation for controlled testing without external state
        service.get_session = AsyncMock()  # TODO: Use real service instance
        # Mock: Session isolation for controlled testing without external state
        service.update_session_activity = AsyncMock()  # TODO: Use real service instance
        # Mock: Session isolation for controlled testing without external state
        service.end_session = AsyncMock()  # TODO: Use real service instance
        yield service

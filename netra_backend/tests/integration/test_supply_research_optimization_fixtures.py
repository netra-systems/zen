"""Test module: test_supply_research_optimization_fixtures.py
...
class TestSupplyResearchOptimizationFixtures:
    """Test class for supply_research_optimization_fixtures"""

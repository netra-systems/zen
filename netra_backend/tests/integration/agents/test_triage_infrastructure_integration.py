...
class TestTriageBaseAgentInheritance:
    ...
    def real_llm_manager():
        ...
        redis.set = AsyncMock()  # TODO: Use real service instance
        return redis
...
class TestWebSocketEventIntegration:
    ...
    def real_llm_manager():
        ...
        # TODO: Initialize real service
        dispatcher = Mock(spec=ToolDispatcher)
        dispatcher.dispatch = AsyncMock()  # TODO: Use real service instance
        return dispatcher
        ...
        bridge.emit_agent_started = AsyncMock()  # TODO: Use real service instance
        bridge.emit_thinking = AsyncMock()  # TODO: Use real service instance
        bridge.emit_tool_executing = AsyncMock()  # TODO: Use real service instance
        bridge.emit_tool_completed = AsyncMock()  # TODO: Use real service instance
        bridge.emit_agent_completed = AsyncMock()  # TODO: Use real service instance
        bridge.emit_progress = AsyncMock()  # TODO: Use real service instance
        bridge.emit_error = AsyncMock()  # TODO: Use real service instance
        return bridge

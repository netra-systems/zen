"""Test module: test_supply_research_optimization_helpers.py
...
class TestSupplyResearchOptimizationHelpers:
    """Test class for supply_research_optimization_helpers"""

"""Test module: test_staging_clickhouse_http_native_ports_managers.py
...
class TestStagingClickhouseHttpNativePortsManagers:
    """Test class for staging_clickhouse_http_native_ports_managers"""

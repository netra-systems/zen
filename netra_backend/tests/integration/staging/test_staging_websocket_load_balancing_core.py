"""Test module: test_staging_websocket_load_balancing_core.py
...
class TestStagingWebsocketLoadBalancingCore:
    """Test class for staging_websocket_load_balancing_core"""

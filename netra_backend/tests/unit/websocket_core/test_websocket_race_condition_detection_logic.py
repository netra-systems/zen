...
class TestWebSocketRaceConditionDetectionLogic(BaseUnitTest):
    ...
    def test_progressive_delay_calculation_accuracy(self):
        ...
        expected_delays = [0.025, 0.05, 0.075]
    ...
    def test_timing_violation_detection(self):
        ...
        long_end_time = start_time + timedelta(milliseconds=200)
    ...
    async def test_handshake_completion_validation_logic(self):
        ...
        expected_states = [ApplicationConnectionState.HANDSHAKE_PENDING, ApplicationConnectionState.CONNECTED, ApplicationConnectionState.READY_FOR_MESSAGES]
    ...
    def test_performance_impact_validation(self):
        ...
        assert avg_calculation_time < 1e-05, f'Progressive delay calculation too slow: {avg_calculation_time * 1000000:.1f}[U+03BC]s per operation'
        assert avg_validation_time < 1e-05, f'Connection validation too slow: {avg_validation_time * 1000000:.1f}[U+03BC]s per operation'

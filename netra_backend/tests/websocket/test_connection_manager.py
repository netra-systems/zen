...
class ConnectionManagerRealConnectionsTests:
    ...
    async def capture_websocket_messages(self, ws_client: WebSocketTestClient, timeout: float=5.0) -> List[Dict]:
...
class WebSocketAgentEventsRealTests:
    ...
    async def test_agent_event_flow_real_websocket(self):
        ...
        context = AgentExecutionContext(run_id='test-run-123', thread_id=conn_id, user_id=conn_id, agent_name='test_agent', retry_count=0, max_retries=1)

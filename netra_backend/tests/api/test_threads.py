...
@pytest.mark.api
class ThreadsAPITests:
    """API test suite for threads"""
    ...
    def test_error_responses(self, client):
        """Test error handling"""
        response = client.get("/api/v1/threads/invalid")
        assert response.status_code == 404
    
    def test_authentication(self, client):
        """Test auth requirements"""
        response = client.get("/api/v1/threads/protected")

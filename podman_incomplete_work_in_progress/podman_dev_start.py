...
class PodmanDevEnvironment:
    ...
    def check_prerequisites(self) -> bool:
        ...
        if runtime_info.runtime != ContainerRuntime.PODMAN:
            print(" FAIL:  Podman not detected. Please install Podman Desktop.")
            return False
        print(f" PASS:  Podman {runtime_info.version} detected")
        ...
        try:
            ...
            if result.returncode == 0:
                print(f" PASS:  podman-compose available")
            else:
                print(" FAIL:  podman-compose not found. Install with: pip install podman-compose")
                return False
        except Exception as e:
            print(f" FAIL:  Error checking podman-compose: {e}")
            return False
        ...
        if not self.compose_file.exists():
            ...
            return False
        print(f" PASS:  Compose file found: {self.compose_file}")
    ...
    def load_env_variables(self):
        ...
        if env_file.exists():
            print(f"[U+1F4CB] Loading environment variables from {env_file}")
            try:
            ...
            print(" WARNING: [U+FE0F]  No .env file found. Using default values.")
    ...
    async def start_services(self) -> bool:
        ...
        print("\n[U+1F680] Starting development services with Podman...")
        ...
        try:
            ...
            # Start services
            print("[U+1F4E6] Starting containers...")
            ...
            print("\n[U+23F3] Waiting for services to become healthy...")
            ...
            print(f"\n FAIL:  Error starting services: {e}")
            import traceback
            traceback.print_exc()
            return False
    ...
    def display_access_info(self):
        ...
        print("\n" + "="*60)
        print(" TARGET:  Services are running at:")
        print("="*60)
    ...
    async def stop_services(self) -> bool:
        ...
        try:
            ...
            if success:
                ...
                print(" WARNING: [U+FE0F]  Some services may not have stopped cleanly")
...
async def main():
    ...
    if not dev_env.check_prerequisites():
        print("\n FAIL:  Prerequisites not met. Please install required tools.")
        sys.exit(1)
    ...
    if args.action == "start":
        ...
        print("[U+267B][U+FE0F]  Restarting services...")

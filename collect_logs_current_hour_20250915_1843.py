...
Target: 5:43 PM PDT to 6:43 PM PDT (00:43 UTC Sept 16 to 01:43 UTC Sept 16)
"""
...
class GCPLogCollector:
    ...
    def collect_logs_last_hour(self):
        ...
        print(f"Time: 5:43 PM PDT to 6:43 PM PDT (Sept 15, 2025)")
        print(f"UTC: 00:43 Sept 16 to 01:43 Sept 16, 2025")
        ...
        for service_name in service_patterns:
            ...
            # Updated time range: 5:43 PM PDT to 6:43 PM PDT (00:43 UTC Sept 16 to 01:43 UTC Sept 16)
            cmd = f'''gcloud logging read "resource.type=cloud_run_revision AND resource.labels.service_name={service_name} AND timestamp>=\\"2025-09-16T00:43:00.000Z\\" AND timestamp<=\\"2025-09-16T01:43:00.000Z\\"" --limit=1000 --format=json --project={self.project}'''
            ...
            if severity in ['ERROR', 'CRITICAL', 'WARNING']:
                ...
                if message:
                    error_patterns.append({
                        ...
                        'full_log': log  # Include full log for detailed analysis
                    })

...
class OAuthBusinessLogicIntegrationTests(SSotBaseTestCase):
    ...
    def auth_env(self):
        ...
        auth_env.set("AUTH_SERVICE_URL", "https://test.netrasystems.ai", source="integration_test")
        auth_env.set("BACKEND_URL", "https://api.test.netrasystems.ai", source="integration_test")

...
1.  **ASSESS SCOPE & COMPLEXITY:** Determine if PM, Design, Implementation, or QA Agents are required (See 3.1). Decompose and delegate as necessary (See 3.2, 3.3). **Explain your reasoning process step-by-step.**
...
11. **ASSESS IMPACT:** **Highlight the critical trade-offs and ethical considerations involved.**

...
return_value = {"access_token": "test-access-token",, "expires_in": 3600,, "token_type": "Bearer"}
                    # Mock user info
    mock_user_response = mock_user_response_instance  # Initialize appropriate service
    mock_user_response.status_code = 200
return_value = {"id": "google-12345",, "email": "user@example.com",, "name": "Test User",, "verified_email": True}

...
from netra_backend.app.services.configuration_service import EnvironmentConfigLoader, ConfigurationValidator, ConfigurationManager, ConfigurationService
...
class EnvironmentConfigLoaderTests:
    ...
    def test_load_config_basic(self):
        ...
        test_vars = {'TEST_VAR1': 'value1', 'TEST_VAR2': 'value2', 'DATABASE_URL': 'postgresql://test:test@localhost:5432/test'}
    ...
    def test_get_database_config_fallback(self):
        ...
        database_url = db_config['DATABASE_URL']
        assert 'localhost' in database_url or database_url.startswith('postgresql://'), 'Fallback should be development database URL'
...
class ConfigurationValidatorTests:
    ...
    def test_validate_database_config_valid(self):
        ...
        self.env.set('POSTGRES_PASSWORD', 'test_password', 'test')
        self.env.set('POSTGRES_DB', 'test_db', 'test')
        config = {'DATABASE_URL': 'postgresql://test_user:test_password@localhost:5434/test_db'}
...
class ConfigurationManagerTests:
    ...
    def test_set_config_basic(self):
        ...
        test_cases = [('STRING_VAR', 'string_value'), ('INT_VAR', 123), ('FLOAT_VAR', 123.45), ('BOOL_VAR', True), ('LIST_VAR', ['item1', 'item2']), ('DICT_VAR', {'key': 'value'})]
...
class ConfigurationServiceErrorHandlingTests:
    ...
    def test_manager_with_type_mismatches(self):
        ...
        manager = ConfigurationManager()
        test_values = [None, '', 0, False, [], {}, 'string', 123, 123.45, True, ['list', 'items'], {'dict': 'value'}]

...
from netra_backend.tests.helpers.triage_test_helpers import AssertionHelpers, AsyncTestHelpers, PerformanceHelpers, TriageMockHelpers
        ...
        def _assert_cache_keys_correct(self, key1, key2, key3):
            ...
            async def test_cache_hit_performance(self, triage_agent, complex_state):
                ...
                def _create_cached_result(self):
                    ...
                    return {'category': 'Cost Optimization', 'priority': 'high', 'confidence_score': 0.9, 'metadata': {'cache_hit': False, 'triage_duration_ms': 150}}
                    ...
                    async def test_cache_invalidation_scenarios(self, triage_agent, complex_state):
                        ...
                        def _setup_corrupted_cache(self, agent, state):
                            ...
                            def _setup_valid_llm_response(self, agent):
                                ...
                                complete_response = {'category': 'Cost Optimization', 'priority': 'high', 'confidence_score': 0.9, 'complexity': 'moderate', 'key_parameters': {}, 'extracted_entities': {}, 'user_intent': {'primary_intent': 'optimize'}, 'suggested_workflow': {'next_agent': 'DataSubAgent'}, 'tool_recommendations': [], 'metadata': {'triage_duration_ms': 150, 'llm_tokens_used': 0, 'cache_hit': False, 'fallback_used': False, 'retry_count': 0}}
                                ...
                                def _assert_fallback_to_llm(self, state):
                                    ...
                                    async def test_cache_warming_strategy(self, triage_agent):
                                        ...
                                        def _get_common_requests(self):
                                            ...
                                            return ['Optimize my AI costs', 'Improve model performance', 'Reduce latency issues', 'Scale my infrastructure', 'Debug API failures']
                                                                                        ...
                                                                                        if hasattr(state.triage_result.metadata, 'error_details'):
                                                                                            ...
                                                                                            async def test_redis_connection_failures(self):
                                                                                                ...
                                                                                                def _setup_successful_llm_response(self, agent):
                                                                                                    ...
                                                                                                    agent.llm_manager.set_responses(['{"category": "General Inquiry", "priority": "medium", "confidence_score": 0.7}'])
                                                                                                        ...
                                                                                                        class TestAsyncOperations:
                                                                                                            ...
                                                                                                            async def test_concurrent_executions(self):
                                                                                                                ...
                                                                                                                def _setup_concurrent_responses(self, agent):
                                                                                                                    ...
                                                                                                                    responses = ['{"category": "Cost Optimization", "priority": "high", "confidence_score": 0.9}', '{"category": "Performance Optimization", "priority": "medium", "confidence_score": 0.8}', '{"category": "Data Management", "priority": "low", "confidence_score": 0.7}']
                                                                                                                    agent.llm_manager.set_responses(responses)
                                                                                                                        ...
                                                                                                                        for state in states:
                                                                                                                            ...
                                                                                                                            async def test_websocket_streaming_updates(self, triage_agent, complex_state):
                                                                                                                                ...
                                                                                                                                def _setup_streaming_response(self, agent):
                                                                                                                                    ...
                                                                                                                                    agent.llm_manager.set_responses(['{"category": "Cost Optimization", "priority": "high", "confidence_score": 0.9}'])

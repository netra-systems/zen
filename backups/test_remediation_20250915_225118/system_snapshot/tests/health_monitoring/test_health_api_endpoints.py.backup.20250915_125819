...
class TestStagingHealthOverview:
    ...
    def test_get_staging_health_overview_success(self, mock_monitor):
        ...
        mock_health_data = {'status': 'healthy', 'service': 'staging_environment', 'version': '1.0.0', 'timestamp': time.time(), 'checks': {'staging_websocket': {'success': True, 'health_score': 1.0, 'response_time_ms': 50.0}, 'database_postgres': {'success': True, 'health_score': 0.95, 'response_time_ms': 25.0}}, 'staging_analysis': {'business_impact': {'impact_level': 'none'}, 'trend_analysis': {'overall_trend': 'stable'}, 'remediation_suggestions': [], 'failure_prediction': {'failure_prediction_available': False}}, 'alert_status': {'alerts_active': False, 'alert_count': 0, 'alert_severity': 'none'}}
    ...
    def test_get_staging_health_overview_simplified(self, mock_monitor):
        ...
        mock_health_data = {'status': 'healthy', 'service': 'staging_environment', 'version': '1.0.0', 'timestamp': time.time(), 'checks': {'staging_websocket': {'success': True, 'health_score': 1.0}, 'database_postgres': {'success': True, 'health_score': 0.95}}}
        mock_monitor.get_comprehensive_health.return_value = mock_health_data
...
class TestWebSocketHealthEndpoint:
    ...
    def test_get_websocket_health_success(self, mock_monitor):
        ...
        mock_health_data = {'status': 'healthy', 'checks': {'staging_websocket': {'success': True, 'health_score': 1.0, 'response_time_ms': 50.0, 'details': {'websocket_server_available': True, 'event_transmission_working': True, 'event_pipeline_functional': True}}}}
        mock_monitor.get_comprehensive_health.return_value = mock_health_data
    ...
    def test_get_websocket_health_degraded(self, mock_monitor):
        ...
        mock_health_data = {'status': 'degraded', 'checks': {'staging_websocket': {'success': False, 'health_score': 0.6, 'response_time_ms': 200.0}}}
        mock_monitor.get_comprehensive_health.return_value = mock_health_data
        response = client.get('/staging/health/websocket')
        assert response.status_code == 200
        data = response.json()
    ...
    def test_get_websocket_health_with_event_details(self, mock_monitor):
        ...
        mock_health_data = {'status': 'healthy', 'checks': {'staging_websocket': {'success': True, 'health_score': 1.0}}}
        mock_monitor.get_comprehensive_health.return_value = mock_health_data
...
class TestDatabaseHealthEndpoint:
    ...
    def test_get_database_health_all_databases(self, mock_monitor):
        ...
        mock_health_data = {'status': 'healthy', 'checks': {'database_postgres': {'success': True, 'health_score': 0.95, 'response_time_ms': 25.0}, 'database_redis': {'success': True, 'health_score': 0.98, 'response_time_ms': 15.0}, 'database_clickhouse': {'success': True, 'health_score': 0.92, 'response_time_ms': 35.0}}}
        mock_monitor.get_comprehensive_health.return_value = mock_health_data
    ...
    def test_get_database_health_specific_database(self, mock_monitor):
        ...
        mock_health_data = {'status': 'healthy', 'checks': {'database_postgres': {'success': True, 'health_score': 0.95, 'response_time_ms': 25.0}}}
        mock_monitor.get_comprehensive_health.return_value = mock_health_data
...
class TestServicesHealthEndpoint:
    ...
    def test_get_services_health_all_services(self, mock_monitor):
        ...
        mock_health_data = {'status': 'healthy', 'checks': {'service_auth_service': {'success': True, 'health_score': 0.98, 'response_time_ms': 100.0}, 'service_backend': {'success': True, 'health_score': 0.95, 'response_time_ms': 120.0}}}
        mock_monitor.get_comprehensive_health.return_value = mock_health_data
    ...
    def test_get_services_health_specific_service(self, mock_monitor):
        ...
        mock_health_data = {'status': 'healthy', 'checks': {'service_auth_service': {'success': True, 'health_score': 0.98, 'response_time_ms': 100.0}}}
        mock_monitor.get_comprehensive_health.return_value = mock_health_data
    ...
    def test_get_services_health_with_dependencies(self, mock_monitor):
        ...
        mock_health_data = {'status': 'healthy', 'checks': {'service_backend': {'success': True, 'health_score': 0.95}}}
        mock_monitor.get_comprehensive_health.return_value = mock_health_data
...
class TestPerformanceMetricsEndpoint:
    ...
    def test_get_performance_metrics_all_types(self, mock_monitor):
        ...
        mock_health_data = {'status': 'healthy', 'checks': {'staging_performance': {'success': True, 'details': {'performance_metrics': {'api_response_time_ms': 200.0, 'websocket_latency_ms': 50.0, 'database_query_time_ms': 30.0}}}, 'staging_resources': {'success': True, 'details': {'cpu_usage_percent': 45.0, 'memory_usage_percent': 60.0, 'disk_usage_percent': 70.0}}}}
        mock_monitor.get_comprehensive_health.return_value = mock_health_data
    ...
    def test_get_performance_metrics_specific_type(self, mock_monitor):
        ...
        mock_health_data = {'status': 'healthy', 'checks': {'staging_performance': {'success': True, 'details': {'performance_metrics': {'api_response_time_ms': 200.0, 'websocket_latency_ms': 50.0, 'database_query_time_ms': 30.0}}}}}
        mock_monitor.get_comprehensive_health.return_value = mock_health_data
    ...
    def test_get_performance_metrics_with_trends(self, mock_monitor):
        ...
        mock_health_data = {'status': 'healthy', 'staging_analysis': {'trend_analysis': {'overall_trend': 'stable', 'recent_average_health_score': 0.95}, 'failure_prediction': {'failure_prediction_available': False, 'potential_failures': []}}}
        mock_monitor.get_comprehensive_health.return_value = mock_health_data
...
class TestCriticalHealthEndpoint:
    ...
    def test_get_critical_health_success(self, mock_monitor):
        ...
        mock_critical_data = {'status': 'healthy', 'service': 'staging_environment_critical', 'checks': {'staging_websocket': {'success': True, 'health_score': 1.0}, 'database_postgres': {'success': True, 'health_score': 0.95}}, 'staging_analysis': {'business_impact': {'impact_level': 'none'}, 'remediation_suggestions': []}, 'alert_status': {'alerts_active': False, 'alert_count': 0, 'alert_severity': 'none'}}
    ...
    def test_get_critical_health_with_failures(self, mock_monitor):
        ...
        mock_critical_data = {'status': 'degraded', 'service': 'staging_environment_critical', 'checks': {'staging_websocket': {'success': False, 'health_score': 0.3}, 'database_postgres': {'success': False, 'health_score': 0.2}}, 'staging_analysis': {'business_impact': {'impact_level': 'critical'}, 'remediation_suggestions': [{'action': 'restart_websocket_service', 'description': 'Restart WebSocket service', 'urgency': 'high'}]}, 'alert_status': {'alerts_active': True, 'alert_count': 2, 'alert_severity': 'critical'}}
        mock_monitor.get_critical_health.return_value = mock_critical_data
    ...
    def test_get_critical_health_custom_threshold(self, mock_monitor):
        ...
        mock_critical_data = {'status': 'degraded', 'checks': {'staging_websocket': {'success': True, 'health_score': 0.75}}, 'staging_analysis': {'remediation_suggestions': []}}
        mock_monitor.get_critical_health.return_value = mock_critical_data
        response = client.get('/staging/health/critical?alert_threshold=0.8')
        assert response.status_code == 200
        data = response.json()
...
class TestHealthAlertsEndpoint:
    ...
    def test_subscribe_to_health_alerts_success(self):
        ...
        webhook_payload = {'webhook_url': 'https://example.com/webhook', 'alert_types': ['critical', 'warning']}
        with patch('netra_backend.app.routes.staging_health._is_valid_webhook_url', return_value=True), patch('netra_backend.app.routes.staging_health._register_webhook_subscription', return_value='sub-123'):
            response = client.post('/staging/health/alerts/subscribe', params={'webhook_url': webhook_payload['webhook_url'], 'alert_types': webhook_payload['alert_types']})
        assert response.status_code == 200
        data = response.json()
    ...
    def test_subscribe_to_health_alerts_invalid_webhook(self):
        ...
        with patch('netra_backend.app.routes.staging_health._is_valid_webhook_url', return_value=False):
            response = client.post('/staging/health/alerts/subscribe', params={'webhook_url': 'invalid-url'})
...
class TestHealthSummaryEndpoint:
    ...
    def test_get_health_summary_success(self, mock_monitor):
        ...
        mock_critical_data = {'status': 'healthy', 'timestamp': time.time(), 'checks': {'staging_websocket': {'success': True}, 'database_postgres': {'success': True}, 'service_auth': {'success': True}}, 'alert_status': {'alerts_active': False, 'alert_count': 0, 'alert_severity': 'none'}}
        mock_monitor.get_critical_health.return_value = mock_critical_data
...
class TestHealthEndpointsIntegration:
    ...
    def test_complete_health_monitoring_workflow(self, mock_monitor):
        ...
        comprehensive_health_data = {'status': 'healthy', 'service': 'staging_environment', 'version': '1.0.0', 'timestamp': time.time(), 'checks': {'staging_websocket': {'success': True, 'health_score': 1.0, 'response_time_ms': 50.0, 'details': {'websocket_server_available': True, 'event_transmission_working': True, 'event_pipeline_functional': True}}, 'database_postgres': {'success': True, 'health_score': 0.95, 'response_time_ms': 25.0}, 'service_auth_service': {'success': True, 'health_score': 0.98, 'response_time_ms': 100.0}, 'staging_performance': {'success': True, 'details': {'performance_metrics': {'api_response_time_ms': 200.0, 'websocket_latency_ms': 50.0, 'database_query_time_ms': 30.0}}}}, 'staging_analysis': {'business_impact': {'impact_level': 'none'}, 'trend_analysis': {'overall_trend': 'stable'}, 'remediation_suggestions': [], 'failure_prediction': {'failure_prediction_available': False}}, 'alert_status': {'alerts_active': False, 'alert_count': 0, 'alert_severity': 'none'}}
        critical_health_data = {'status': 'healthy', 'service': 'staging_environment_critical', 'timestamp': time.time(), 'checks': {'staging_websocket': {'success': True, 'health_score': 1.0}, 'database_postgres': {'success': True, 'health_score': 0.95}, 'service_auth_service': {'success': True, 'health_score': 0.98}}, 'focus': 'critical_components_only'}
        ...
        statuses = [overview_data['status'], websocket_data['status'], database_data['status'], services_data['status'], critical_data['status'], summary_data['overall_status']]

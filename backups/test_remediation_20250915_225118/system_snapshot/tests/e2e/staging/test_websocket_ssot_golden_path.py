...
class WebSocketSSoTGoldenPathStagingTests(SSotAsyncTestCase):
    ...
    async def setup_class(cls):
        ...
        cls.staging_base_url = cls.env.get('STAGING_BASE_URL', 'https://staging.netrasystems.ai')
        cls.staging_ws_url = cls.env.get('STAGING_WS_URL', 'wss://staging.netrasystems.ai/ws')
        cls.staging_auth_url = cls.env.get('STAGING_AUTH_URL', 'https://auth.netrasystems.ai')
        
        # Test credentials for staging environment
        cls.test_email = cls.env.get('STAGING_TEST_EMAIL', 'test@netrasystems.ai')

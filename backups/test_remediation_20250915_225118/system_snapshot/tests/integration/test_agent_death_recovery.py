...
assert detected, "formatted_string"
...
assert total_notifications >= 3, "formatted_string"
...
await simulators[i].complete_successfully({"concurrent_test": "formatted_string"})

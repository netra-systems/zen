...
class RealWebSocketEventValidator:
    ...
    def validate_basic_flow(self) -> tuple[bool, List[str]]:
        ...
        if missing_events:
            errors.append(fMissing events: {missing_events})"
...
class RealWebSocketSubAgentTests:
    ...
    async def test_websocket_notifier_basic_events(self):
        ...
        connection_id = ftest-real-{uuid.uuid4().hex[:8]}"
        ...
        class EventCapturingWebSocket:
            async def send_json(self, data):
                ...
                logger.info(fCaptured event: {data.get('type')})
        ...
        assert is_valid, fWebSocket events validation failed: {errors}"
    ...
    async def test_websocket_manager_connection_real(self):
        ...
        try:
            ...
            pytest.skip(fReal services not available: {e})
        ...
        class WebSocketTests:
            async def send_json(self, data):
                ...
                logger.info(fManager sent: {data.get('type')}")

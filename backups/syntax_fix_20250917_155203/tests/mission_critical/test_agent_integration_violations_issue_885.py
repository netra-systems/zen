...
"
        ...
        self.assertGreater(
            ...
            fAGENT REGISTRY INTEGRATION VIOLATION: Found {len(registry_integration_violations)} integration violations. 
    ...
    ""
        ...
        self.assertGreater(
            ...
            fEVENT INTEGRATION VIOLATION: Found {len(event_integration_violations)} event integration violations. 
    ...
    ""
        ...
        self.assertGreater(
            ...
            fAgent execution components should be properly integrated with WebSocket system. 
...
""
        ...
        try:
            ...
            violation = fMessage routing integration test failed: {e}
            routing_integration_violations.append(violation)
            self.integration_violations.append(violation)
        ...
        self.assertGreater(
            ...
            fMessage routing should be properly integrated between WebSocket and agents. 
...
"
        ...
        try:
            ...
            violation = fAgent lifecycle integration test failed: {e}
            lifecycle_integration_violations.append(violation)
            self.integration_violations.append(violation)
        ...
        logger.error(fLIFECYCLE INTEGRATION VIOLATIONS: {len(lifecycle_integration_violations)} violations detected)

...
class UserAgentMessageTypesTests:
    ...
    async def test_full_websocket_simulation(self):
        ...
        user_id = 7c5e1032-ed21-4aea-b12a-aeddf3622bec
        connection_id = fconn_{user_id}_405ad7f8
        ...
        for message_data in test_messages:
            ...
            assert isinstance(success, bool), froute_message should return bool for {message_data['type']}""
            assert success == True, fMessage type '{message_data['type']}' should be routed successfully

...
Migration:
  FROM: from test_framework.redis_test_utils.test_redis_manager import RedisTestManager
...
class RedisImportMigrationTool:
    ...
    def __init__(self, project_root: str):
        ...
        self.import_patterns = [
            r"from test_framework\.redis_test_utils\.test_redis_manager import RedisTestManager",
        ...
        self.usage_patterns = [
            (r"RedisTestManager\(\)", "redis_manager"),
            (r"RedisTestManager", "redis_manager"),
        ]

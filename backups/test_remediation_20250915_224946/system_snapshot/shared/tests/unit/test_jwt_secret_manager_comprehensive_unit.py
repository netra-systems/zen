...
import gc
from shared.jwt_secret_manager import JWTSecretManager, get_jwt_secret_manager, get_unified_jwt_secret, get_unified_jwt_algorithm, validate_unified_jwt_config, SharedJWTSecretManager, _jwt_secret_manager
...
class TestJWTSecretManagerValidation:
    ...
    def test_unusual_algorithm_warning(self):
        ...
        self.env.set('JWT_ALGORITHM', 'ES256', 'test')
        manager = get_jwt_secret_manager()
        result = manager.validate_jwt_configuration()
...
class TestLegacyCompatibilitySharedJWTSecretManager:
    ...
    def test_legacy_validate_jwt_secret(self):
        ...
        valid_secrets = ['12345678901234567890123456789012', '123456789012345678901234567890123', 'a' * 50]
        ...
        invalid_secrets = [None, '', 'short', '12345678901234567890123456789', '1234567890123456789012345678901']
...
class TestJWTSecretManagerPerformanceAndScalability:
    ...
    def test_concurrent_authentication_simulation(self):
        ...
        ops_per_second = total_operations / max(total_time, 0.001)
    ...
    def test_complete_authentication_workflow_simulation(self):
        ...
        try:
            ...
            for user_id in range(50):
                ...
                authentication_results.append({'user_id': user_id, 'secret': secret, 'algorithm': algorithm, 'secret_length': len(secret)})

"""
Websocket Notifier Ssot Violations tests - Rewritten from corrupted file.
...
class TestWebsocketnotifierssotviolations(SSotBaseTestCase):
    """Test class for websocket notifier ssot violations."""

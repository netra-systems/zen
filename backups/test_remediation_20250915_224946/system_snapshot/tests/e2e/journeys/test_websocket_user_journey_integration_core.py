"""Test module: test_websocket_user_journey_integration_core.py
...
@pytest.mark.e2e
class WebsocketUserJourneyIntegrationCoreTests:
    """Test class for websocket_user_journey_integration_core"""

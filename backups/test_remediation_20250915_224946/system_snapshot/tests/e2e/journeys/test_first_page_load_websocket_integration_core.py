"""Test module: test_first_page_load_websocket_integration_core.py
...
@pytest.mark.e2e
class FirstPageLoadWebsocketIntegrationCoreTests:
    """Test class for first_page_load_websocket_integration_core"""

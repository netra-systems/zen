"""Test module: test_websocket_advanced_integration_helpers.py
...
@pytest.mark.e2e
class WebsocketAdvancedIntegrationHelpersTests:
    """Test class for websocket_advanced_integration_helpers"""

"""Test module: test_corpus_generation_pipeline_integration_core.py
...
@pytest.mark.e2e
class CorpusGenerationPipelineIntegrationCoreTests:
    """Test class for corpus_generation_pipeline_integration_core"""

...
class AgentWebSocketBridgeE2EIntegrationTests(BaseTestCase):
    ...
    async def test_users(self, auth_helper):
        ...
        user_configs = [
            {"email": "bridge_enterprise@netrasystems.ai", "name": "Bridge Enterprise", "user_type": "enterprise"},
            {"email": "bridge_mid@netrasystems.ai", "name": "Bridge Mid Tier", "user_type": "mid"},
            {"email": "bridge_free@netrasystems.ai", "name": "Bridge Free", "user_type": "free"}
        ]

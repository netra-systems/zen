"""Test module: test_agent_resource_cleanup_integration_core.py
...
@pytest.mark.e2e
class AgentResourceCleanupIntegrationCoreTests:
    """Test class for agent_resource_cleanup_integration_core"""

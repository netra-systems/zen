...
metadata={"malicious_payload": "<script>alert('xss')</script>",, "sql_injection": ""; DROP TABLE users; --",, "command_injection": "; rm -rf /"}
...
"""
        ...
        supervisor = await SupervisorAgent.create_with_user_context(llm_manager=mock_llm_manager,, websocket_bridge=mock_websocket_bridge,, tool_dispatcher=mock_tool_dispatcher,, user_context=secure_context)
...
malicious_metadata = {"search_term": ""; DROP TABLE users; --",, "user_input": "<script>alert('xss')</script>",, "file_path": "../../../etc/passwd",, "command": "; rm -rf /",, "json_payload": '{"admin": true}'}
        # Create child context with malicious metadata
        child_context = secure_context.create_child_context(operation_name="test_operation",, additional_metadata=malicious_metadata)
...
"""
    ...
    # Create child context
        child_context = parent_context.create_child_context(operation_name="child_operation",, additional_metadata={"child_secret": "child_data"})

...
class ComprehensiveDatabaseConnectivityValidator:
    ...
    async def validate_docker_services_health(self) -> Dict[str, Any]:
        ...
        try:
        pg_url = "formatted_string"
        conn = await asyncpg.connect(pg_url, timeout=10.0)
        await conn.fetchval("SELECT 1")
        await conn.close()
        result['services']['postgresql'] = {'healthy': True, 'url': "formatted_string"}
        except Exception as e:
        ...
        result['services']['redis'] = {'healthy': True, 'url': "formatted_string"}
        except Exception as e:
        ...
        ch_client.close()
        result['services']['clickhouse'] = {'healthy': True, 'url': "formatted_string"}
        except Exception as e:
...
time_info = "formatted_string"
timeout_info = "formatted_string"

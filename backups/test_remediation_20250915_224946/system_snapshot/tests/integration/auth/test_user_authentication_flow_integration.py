        ...
        self.test_users = [
            {
                ...
                "email": "authflow1@netrasystems.ai",
            ...
            },
            {
                ...
                "email": "authflow2@netrasystems.ai",
        ...
        try:
            ...
            validation_scenarios = [
                ...
                },
                {
                    "name": "weak_password",
                    "data": {
                        "email": "weakpass@netrasystems.ai",
                        "password": "weak",
                        "name": "Test User" 
                    },
                    "should_fail": True
            ...
            async with httpx.AsyncClient() as client:
                ...
                failure_scenarios = [
                    ...
                    },
                    {
                        ...
                        "credentials": {
                            "email": "nonexistent@netrasystems.ai", 

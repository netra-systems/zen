...
class CircuitBreakerEdgeCasesTests:
    ...
    def test_circuit_breaker_rapid_failures(self, mock_llm_manager):
        ...
        agent = MockFailingAgent(llm_manager=mock_llm_manager, failure_mode='execution', max_failures=10, enable_reliability=True)
...
class CacheCorruptionScenariosTests:
    ...
    def test_cache_corruption_handling(self, mock_llm_manager):
        ...
        agent = MockFailingAgent(llm_manager=mock_llm_manager, enable_reliability=True)

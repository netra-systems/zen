...
class ToolDispatcherIntegrationTests:
    ...
    async def test_create_tool_dispatcher_for_user_creates_isolated_dispatcher(self, mock_unified_dispatcher, mock_llm_manager, test_user_context):
    ...
    @patch('netra_backend.app.core.tools.unified_tool_dispatcher.UnifiedToolDispatcher')
    async def test_create_tool_dispatcher_for_user_with_admin_tools(self, mock_unified_dispatcher, mock_llm_manager, test_user_context):
    ...
    @patch('netra_backend.app.core.tools.unified_tool_dispatcher.UnifiedToolDispatcher')
    async def test_default_dispatcher_factory_uses_unified_dispatcher(self, mock_unified_dispatcher, mock_llm_manager, test_user_context):

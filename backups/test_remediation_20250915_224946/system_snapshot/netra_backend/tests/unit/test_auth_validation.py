...
class AuthValidationTests(SSotBaseTestCase):
    ...
    def test_redirect_uri_building_logic(self):
        ...
        prod_request.base_url = "https://api.netrasystems.ai/"
        
        prod_uri = build_redirect_uri(prod_request)
        assert prod_uri == "https://api.netrasystems.ai/auth/callback"
        
        # Test with trailing slash handling
        trailing_request = MagicMock()
        trailing_request.base_url = "https://staging.netrasystems.ai//"

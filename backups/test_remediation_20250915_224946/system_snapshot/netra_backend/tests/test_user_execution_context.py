...
class UserExecutionContextValidationTests:
    ...
    def test_valid_context_creation(self):
        ...
        context = UserExecutionContext(user_id='user_12345', thread_id='thread_67890', run_id='run_abcdef', request_id='req_xyz123')
    ...
    def test_user_id_none_validation(self):
        ...
        with pytest.raises(ValueError, match='UserExecutionContext.user_id cannot be None'):
            UserExecutionContext(user_id=None, thread_id='thread_67890', run_id='run_abcdef', request_id='req_xyz123')
    ...
    def test_user_id_empty_validation(self):
        ...
        with pytest.raises(ValueError, match='UserExecutionContext.user_id cannot be empty'):
            UserExecutionContext(user_id='', thread_id='thread_67890', run_id='run_abcdef', request_id='req_xyz123')
    ...
    def test_thread_id_none_validation(self):
        ...
        with pytest.raises(ValueError, match='UserExecutionContext.thread_id cannot be None'):
            UserExecutionContext(user_id='user_12345', thread_id=None, run_id='run_abcdef', request_id='req_xyz123')
    ...
    def test_thread_id_empty_validation(self):
        ...
        with pytest.raises(ValueError, match='UserExecutionContext.thread_id cannot be empty'):
            UserExecutionContext(user_id='user_12345', thread_id='', run_id='run_abcdef', request_id='req_xyz123')
    ...
    def test_run_id_none_validation(self):
        ...
        with pytest.raises(ValueError, match='UserExecutionContext.run_id cannot be None'):
            UserExecutionContext(user_id='user_12345', thread_id='thread_67890', run_id=None, request_id='req_xyz123')
    ...
    def test_run_id_empty_validation(self):
        ...
        with pytest.raises(ValueError, match='UserExecutionContext.run_id cannot be empty'):
            UserExecutionContext(user_id='user_12345', thread_id='thread_67890', run_id='', request_id='req_xyz123')
    ...
    def test_run_id_registry_validation(self):
        ...
        with pytest.raises(ValueError, match="UserExecutionContext.run_id cannot be 'registry'"):
            UserExecutionContext(user_id='user_12345', thread_id='thread_67890', run_id='registry', request_id='req_xyz123')
    ...
    def test_request_id_none_validation(self):
        ...
        with pytest.raises(ValueError, match='UserExecutionContext.request_id cannot be None'):
            UserExecutionContext(user_id='user_12345', thread_id='thread_67890', run_id='run_abcdef', request_id=None)
...
class UserExecutionContextMethodsTests:
    ...
    def test_to_dict_method(self):
        ...
        expected = {'user_id': 'user_12345', 'thread_id': 'thread_67890', 'run_id': 'run_abcdef', 'request_id': 'req_xyz123'}
        assert result == expected

    def test_str_method_truncates_user_id(self):
        """Test that __str__ truncates long user_id for security."""
        context = UserExecutionContext(user_id='user_very_long_id_12345', thread_id='thread_67890', run_id='run_abcdef', request_id='req_xyz123')
    ...
    def test_str_method_short_user_id(self):
        ...
        context = UserExecutionContext(user_id='user123', thread_id='thread_67890', run_id='run_abcdef', request_id='req_xyz123')
        str_result = str(context)
...
class UserExecutionContextEdgeCasesTests:
    ...
    def test_multiple_validation_failures(self):
        ...
        with pytest.raises(ValueError, match='UserExecutionContext.user_id cannot be None'):
            UserExecutionContext(user_id=None, thread_id=None, run_id='registry', request_id='')
    ...
    def test_special_characters_in_values(self):
        ...
        context = UserExecutionContext(user_id='user@domain.com', thread_id='thread-with-dashes_and_underscores.123', run_id='run:with:colons/and/slashes', request_id='req#with$special%chars&symbols')

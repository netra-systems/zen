...
from netra_backend.app.agents.triage.unified_triage_agent import Complexity, ExtractedEntities, KeyParameters, Priority, TriageResult, UserIntent
from netra_backend.app.agents.triage.unified_triage_agent import UnifiedTriageAgent
from netra_backend.tests.helpers.triage_test_helpers import EdgeCaseHelpers, EntityExtractionHelpers, IntentHelpers, PerformanceHelpers, TriageMockHelpers
                ...
                async def test_unicode_and_special_characters(self, triage_agent):
                    ...
                    for request in unicode_requests:
                        ...
                        async def _test_unicode_request(self, agent, request):
                            ...
                            state = DeepAgentState(user_request=request)
                            agent.llm_manager.set_responses(['{"category": "Cost Optimization", "priority": "medium", "confidence_score": 0.8}'])
                                                            ...
                                                            for size in request_sizes:
                                                                ...
                                                                async def _test_request_size_performance(self, agent, size):
                                                                    ...
                                                                    async def test_memory_efficiency(self, triage_agent):
                                                                        ...
                                                                        triage_agent.llm_manager.set_responses(['{"category": "Performance Optimization", "priority": "high", "confidence_score": 0.85}'])
                                                                        ...
                                                                        def test_hash_generation_performance(self, triage_agent):
                                                                            ...
                                                                            for test_input in test_inputs:
                                                                                ...
                                                                                def _get_hash_test_inputs(self):
                                                                                    ...
                                                                                    return ['Short request', 'Medium length request with some technical details about optimization', 'Very long request ' * 100 + ' with lots of repeated content and technical jargon about AI model optimization, cost reduction, performance improvements, and various metrics and thresholds']
                                                                                        ...
                                                                                        class PydanticModelValidationTests:
                                                                                            ...
                                                                                            def test_triage_result_comprehensive_validation(self):
                                                                                                ...
                                                                                                def _create_comprehensive_triage_result(self):
                                                                                                    ...
                                                                                                    return TriageResult(category='Cost Optimization', confidence_score=0.85, priority=Priority.HIGH, complexity=Complexity.MODERATE, key_parameters=key_params, metadata=metadata)

                                                                                                def _create_test_key_parameters(self):
                                                                                                    """Create test key parameters"""
                                                                                                    return KeyParameters(workload_type='inference', optimization_focus='cost', constraints=['latency < 100ms'])
                                                                                                ...
                                                                                                def _assert_triage_result_valid(self, result):
                                                                                                    ...
                                                                                                    def test_triage_result_edge_case_validation(self):
                                                                                                        ...
                                                                                                        def _create_minimal_triage_result(self):
                                                                                                            ...
                                                                                                            return TriageResult(category='Test', confidence_score=0.0, priority=Priority.LOW, complexity=Complexity.SIMPLE)

                                                                                                        def _create_max_confidence_result(self):
                                                                                                            """Create maximum confidence result"""
                                                                                                            return TriageResult(category='Test', confidence_score=1.0, priority=Priority.CRITICAL, complexity=Complexity.EXPERT)
